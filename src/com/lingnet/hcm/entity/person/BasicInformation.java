...
public class BasicInformation extends BaseEntity implements java.io.Serializable {
	...
	private String nativePlaceP;//籍贯--省
	private String nativePlaceC;//籍贯--市
	private String nativePlaceA;//籍贯--区
...
/*	private String lbpost;//劳保所属岗位
	private String lbpostId;//劳保所属岗位ID
*/	private String classGroup;//班组
	...
	private String annualLeave;//年假扣减工龄
...
/*	public String getLbpost() {
	...
	@Column(name = "LBPOST_ID")
	public String getLbpostId() {
		return lbpostId;
	}

	public void setLbpostId(String lbpostId) {
		this.lbpostId = lbpostId;
	}*/
}