...
public class Change extends BaseEntity implements java.io.Serializable {
    ...
    private String salaryPostName;// 原薪酬岗位
    ...
    private String salaryPostName2;// 现薪酬岗位
    private String personId;//人员id
    private Integer isDeal; // 薪酬是否已处理 0：未处理 1：已处理
    ...
    @Column(name = "SALARY_POST_NAME2")
    public String getSalaryPostName2() {
        return salaryPostName2;
    }

    public void setSalaryPostName2(String salaryPostName2) {
        this.salaryPostName2 = salaryPostName2;
    }
	...
	@Column(name = "IS_DEAL", precision = 1, scale = 0)
