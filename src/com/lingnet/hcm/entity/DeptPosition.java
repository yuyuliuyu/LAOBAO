 ...
 */
@Entity
@Table(name = "DEPT_POSITION")
public class DeptPosition extends BaseEntity implements java.io.Serializable {
	...
	private String positionId;//标准岗位id
	private String positionDesc;//职位说明书
	private String deptId;
    private Integer overtimemax; //加班上限
    
	private Integer postType;//岗位类别
	private Integer postOrder;//岗位序列
	private String postExplain;//岗位说明
	...
	/** full constructor */
	public DeptPosition(String id, Date createdate, Date modifydate,
