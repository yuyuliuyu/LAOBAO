...
public class SalaryAssignation extends BaseEntity implements java.io.Serializable {
    ...
    private Integer allowEdit;// 保险允许修改 0:不能修改1：可以修改
    private String process;// 流程选择
    private String salaryGroupName;// 薪资组名称
    private String salaryPeriodName;// 薪酬期间名称
    private String salaryWageName;// 工资套名称
    private String processName;// 流程选择名称
    ...
    @Column(name = "ALLOW_EDIT", precision = 1, scale = 0)
