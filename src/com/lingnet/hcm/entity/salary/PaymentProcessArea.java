...
/**
 * 保险缴费过程缴费地域中间表
 * XcPaymentProcessArea entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "XC_PAYMENT_PROCESS_AREA")
public class PaymentProcessArea extends BaseEntity implements java.io.Serializable {

    private static final long serialVersionUID = -4411453953278176843L;
