...
public class SalaryManageAction extends BaseAction {
    ...
    public String getBranches() {
        ...
        if (!StringUtils.isBlank(bm)) {
            and.add(Restrictions.like("jm", bm.trim(), MatchMode.ANYWHERE));
        }
        // 名称查询
        ...
        if (StringUtils.isBlank(depId)) {
            list = getOrderBeanListByCriteria(Branch.class, Order.asc("jm"), Restrictions.eq("isDelete", 0), and);
        } else {
            list = getOrderBeanListByCriteria(Branch.class, Order.asc("jm"), Restrictions.eq("id", depId), Restrictions.eq("isDelete", 0), and);
        }
