...
@Entity
@Table(name = "BRANCH")
public class Branch extends BaseEntity implements java.io.Serializable {

    private static final long serialVersionUID = 1L;
    private String fzx;// 单位名称
    private String jm;// 简称，不能重复
    private String srm;// 输入码
    private String pid;//父级Id
    private Integer isDelete;//0未删除 1 已删除 2撤销
    ...
    private Date cmEstablishDate;// 成立日期
    private Date cmYyqxHigh;// 营业期限上限
    private Date cmYyqxLow;// 营业期限下限
    ...
    /** full constructor */
    public Branch(String id, String fzx, String jm, String srm) {
        this.fzx = fzx;
        this.jm = jm;
        this.srm = srm;
    }
    ...
    public Date getCmEstablishDate() {
        return cmEstablishDate;
    }

    public void setCmEstablishDate(Date cmEstablishDate) {
        this.cmEstablishDate = cmEstablishDate;
    }

    @Column(name="CM_YYQX_HIGH")
    public Date getCmYyqxHigh() {
        return cmYyqxHigh;
    }

    public void setCmYyqxHigh(Date cmYyqxHigh) {
        this.cmYyqxHigh = cmYyqxHigh;
    }

    @Column(name="CM_YYQX_LOW")
    public Date getCmYyqxLow() {
        return cmYyqxLow;
    }

    public void setCmYyqxLow(Date cmYyqxLow) {
