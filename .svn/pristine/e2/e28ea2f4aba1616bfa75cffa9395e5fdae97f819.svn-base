...
<body>
    <form id="form1" method="post">
        ...
        <table cellpadding="0" cellspacing="0" border="0" class="addtable" width="100%">
                ...
                <tr>
                    <td class="list_left_box1" valign="top" width="15%">争议编号：</td>
                    ...
                    <td class="list_left_box1" valign="top" width="15%">争议类型：</td>
                    <td class="list_right_box" width="30%">
                        <input name="xh" id="xh" class="mini-textbox" value="${cd.xh}"
                ...
                <tr>
                    <td class="list_left_box1" valign="top" width="15%">争议实体：</td>
                    <td class="list_right_box" width="30%">
                        <input name="xh" id="xh" class="mini-textbox" value="${cd.xh}"
                                vtype="maxLength:20;required" width="200px"/>
                    </td> 
                    <td class="list_left_box1" valign="top" width="15%">争议发起方：</td>
                    <td class="list_right_box" width="30%">
                        <input name="xh" id="xh" class="mini-textbox" value="${cd.xh}"
                                vtype="maxLength:50" width="200px"/>
                    </td> 
                ...
                <tr>
                    <td class="list_left_box1" valign="top" width="15%">争议开始日期：</td>
                    <td class="list_right_box" width="30%">
                        <input name="xh" id="xh" class="mini-textbox" value="${cd.xh}"
                                vtype="maxLength:20;required" width="200px"/>
                    </td> 
                    <td class="list_left_box1" valign="top" width="15%">争议结束日期：</td>
                    <td class="list_right_box" width="30%">
                        <input name="xh" id="xh" class="mini-textbox" value="${cd.xh}"
                                vtype="maxLength:50" width="200px"/>
                    </td> 
                ...
                <tr>
                    <td class="list_left_box1" valign="top" width="15%">争议发起方要求：</td>
                    <td class="list_right_box" width="30%">
                        <input name="xh" id="xh" class="mini-textbox" value="${cd.xh}"
                ...
                <tr>
                    <td class="list_left_box1" valign="top" width="15%">争议原因：</td>
                    <td class="list_right_box" width="30%">
                        <input name="xh" id="xh" class="mini-textbox" value="${cd.xh}"
                                vtype="maxLength:20;required" width="100%"/>
                    </td> 
                ...
                <tr>
                    <td class="list_left_box1" valign="top" width="15%">争议说明：</td>
                    <td class="list_right_box" width="30%">
                        <input name="xh" id="xh" class="mini-textbox" value="${cd.xh}"
                                vtype="maxLength:20;required" width="100%"/>
                    </td> 
