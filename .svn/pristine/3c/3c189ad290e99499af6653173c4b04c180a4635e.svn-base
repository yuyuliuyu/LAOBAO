...
/**
 * 缴费基数过程福利项目中间表
 * XcBaseProcessFuli entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "XC_BASE_PROCESS_FULI")
public class BaseProcessFuli extends BaseEntity implements java.io.Serializable {

    private static final long serialVersionUID = 7417426363949931770L;
