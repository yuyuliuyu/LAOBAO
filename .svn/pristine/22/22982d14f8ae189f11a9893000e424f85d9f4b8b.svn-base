...
<body>
    ...
    <div class="mini-fit">
        <div id="grid" class="mini-datagrid" style="width:100%;height:100%;" 
             url="../check/rest!getApplyData.action" idField="id" multiSelect="true" 
    ...
    <script type="text/javascript">
		...
		function edit() {
			...
			if (rows.length <= 0){
				...
				mini.open({
					url : "../check/rest!edit.action?id=" + row.id,
					title : "修改休假申请",
					width : 600,
					height : 400,
					/* allowResize:false, */
        ...
        function view(id) {
        	mini.open({
					url : "../check/rest!viewOptionList.action?id=" + id,
					title : "查看审核信息",
					width : 800,
					height : 450,
					/* allowResize:false, */
