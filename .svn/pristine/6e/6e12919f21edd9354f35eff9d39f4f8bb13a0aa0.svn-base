...
<body>
	            ...
	            <div class="mini-toolbar" style="padding:0px;border-top:0;">
	       			 <table style="width:100%;">
			                ...
			                <td style="width:100%;">
			                    ...
			                    <a class="mini-button" iconCls="icon-user" onclick="partake()">参与人员</a>
			                </td>
	            		 </tr>
	        		</table>
	    		</div>
	    		<div id="grid1" class="mini-datagrid" style="width:100%;height:94%;"showTreeIcon="true"
		             treeColumn="name" idField="did" parentField="pid" resultAsTree="false" allowResize="false" expandOnLoad="true">
		                <div property="columns">
	                        ...
	                        <div field="name" id ="name" name = "name"width="100" headerAlign="center" align="left">培训渠道</div>
	                        <div field="name" id ="name" name = "name"width="100" headerAlign="center" align="left">培训形式</div>
	                        <div field="name" id ="name" name = "name"width="100" headerAlign="center" align="left">培训地点</div>
	                        <div field="name" id ="name" name = "name"width="100" headerAlign="center" align="left">培训机构联系人</div>
	                        <div field="name" id ="name" name = "name"width="100" headerAlign="center" align="left">培训课程名称</div>
	                        ...
	                        <div field="name" id ="name" name = "name"width="100" headerAlign="center" align="left">总课时数</div>
	                        <div field="name" id ="name" name = "name"width="100" headerAlign="center" align="left">预算经费</div>
	                        <div field="name" id ="name" name = "name"width="100" headerAlign="center" align="left">参与部门</div>
	                        <div field="name" id ="name" name = "name"width="100" headerAlign="center" align="left">参与人</div>
    ...
    grid.load();
    	...
    	function partake(){
    		window.location.href="../train/train_partake!list.action";
    	}
    </script>
</body>
</html>