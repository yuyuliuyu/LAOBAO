                    ...
                    <td class="list_right_box" >
                    	 <input class="mini-datepicker" format="yyyy-MM-dd"
							id="punishdate" name="punishdate" style="width: 90%" msg="日期格式不正确" allowInput="false"
								required="true"	 value="${punish.punishdate}"/>
                    </td>
                </tr>
                <tr>
               ...
               <tr>
                ...
                <tr>
                 ...
                 <tr>
                    ...
                    <td class="list_right_box" >
                         <input name="fileNum" id="fileNum" class="mini-textarea" value="${punish.fileNum}"
                                 style="width:90%;"/>
                    </td>
                    <td class="list_left_box1" valign="top" >文件名称：</td>
                    <td class="list_right_box" >
                         <input name="fileName" id="fileName" class="mini-textarea" value="${punish.fileName}"
                                 style="width:90%;"/>
                    </td>
                </tr>
