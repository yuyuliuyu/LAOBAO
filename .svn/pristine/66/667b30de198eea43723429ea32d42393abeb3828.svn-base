	...
	<div class="mini-fit" >
        ...
        <input class="mini-hidden" name="attachment" id="attachment" value="${orgHisMiddle.attachment}" style="display:none;"/>
            ...
            <tr>
                ...
                <td class="list_right_box" width="35%">
                	<input name="parent" id="parent" class="mini-buttonedit" value="${deptChange.parent}"
            ...
            <tr>
                <td class="list_left_box1" valign="top">部门编码：</td>
                <td class="list_right_box" >
                    <input name="input_code" id="input_code" class="mini-textarea" value="${deptChange.input_code}"
                           enabled="true" vtype="maxLength:100" width="200px" />
                </td>
                <td class="list_left_box1" valign="top">成立日期：</td>
                <td class="list_right_box" >
                    <input name="setupDate" id="setupDate" class="mini-datepicker" value="${deptChange.setupDate}"
