    ...
    <script type="text/javascript">
        ...
        function onTabsActiveChanged(e) {
            ...
            if(tab.title == "人事资料"){
            	...
            	iframe.src = "../personnel/personnel!personedit.action?personId=${personId}&flag=1"; 
            } else if (tab.title == "教育经历"){
            	var iframe = document.getElementById("framejyjl");
            	iframe.src = "../empdata/edu_record!perlist.action?flag=1&personId=${personId}"; 
			    
            } else if (tab.title == "职业履历"){
            	var iframe = document.getElementById("framezyll");
            	iframe.src = "../empdata/career!perlist.action?flag=1&personId=${personId}"; 
            	...
            	iframe.src = "../empdata/social_relation!perlist.action?flag=1&personId=${personId}"; 
			    
            }else if (tab.title == "证照管理"){
            	var iframe = document.getElementById("framezzgl");
            	iframe.src = "../empdata/license!perlist.action?flag=1&personId=${personId}"; 
			    
            }else if (tab.title == "技工信息"){
            	var iframe = document.getElementById("jgxx");
            	iframe.src = "../empdata/skilled_emp!perlist.action?flag=1&personId=${personId}"; 
			    
            }else if (tab.title == "员工技能"){
            	var iframe = document.getElementById("ygjn");
            	iframe.src = "../empdata/emp_skill!perlist.action?flag=1&personId=${personId}"; 
            	...
            	iframe.src = "../contract/contract_manager!list.action?flag=1&personId=${personId}";
             	...
             	iframe.src = "../contract/employ_agreement!list.action?flag=1&personId=${personId}";
              	...
              	iframe.src = "../empdata/job_title!perlist.action?flag=1&personId=${personId}"; 
  			    
            }else if (tab.title == "健康档案"){
            	var iframe = document.getElementById("framejkda");
            	iframe.src = "../empdata/health!perlist.action?flag=1&personId=${personId}"; 
            	...
            	iframe.src = "../empdata/award!perlist.action?flag=1&personId=${personId}"; 
			    
            }else if (tab.title == "惩罚记录"){
            	var iframe = document.getElementById("cfjl");
            	iframe.src = "../empdata/punish!perlist.action?flag=1&personId=${personId}"; 
            	...
            	iframe.src = "../empdata/emp_welfare!perlist.action?flag=1&personId=${personId}"; 
			    
            }else if (tab.title == "工伤管理"){
            	var iframe = document.getElementById("gsgl");
            	iframe.src = "../empdata/injury!perlist.action?flag=1&personId=${personId}"; 
			    
            }else if (tab.title == "复转情况"){
            	var iframe = document.getElementById("fzqk");
            	iframe.src = "../empdata/soldier_back!perlist.action?flag=1&personId=${personId}"; 
