	            ...
	            <div class="mini-toolbar" style="padding:0px;border-top:0;">
	       			 <table style="width:100%;">
			                ...
			                <td style="width:100%;">
			                    ...
			                    <a class="mini-button" iconCls="icon-tip" onclick="zhuanzheng()">结束试岗期</a>
	    		...
	    		<div id="grid" class="mini-datagrid" style="width:100%;height:100%;" 
            		 ...
            		 allowAlternating="true" pageSize="100" >
		                <div property="columns">
	                        ...
	                        <div field="jssyDate" id ="jssyDate" name = "jssyDate" width="100" headerAlign="center" align="center" >试岗期结束时间</div>
	                        <div field="contDate" id ="contDate" name = "contDate" width="100" headerAlign="center" align="center" >距离结束剩余时间</div>
