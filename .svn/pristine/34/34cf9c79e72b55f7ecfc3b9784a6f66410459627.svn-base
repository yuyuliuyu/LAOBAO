...
<body>
    ...
    <div  style="width:40%;float:right" >
    	<img src="${path}" onload="if (this.width>420 || this.height>500) if (this.width/this.height>430/500) this.width=430; else this.height=500;"/>
    </div>
    <script type="text/javascript">
        mini.parse();
        var tree=window.parent.mini.get("tree");
        ...
        function showjgt(){
            ...
            if (!tab) {
                ...
                tab.url = "../basis/branch!treelist.action";
                tabs.addTab(tab);
            } else tab.url = "../basis/branch!treelist.action";
            tabs.activeTab(tab);
            tabs.reloadTab(tab);
        }
        function showls(){
