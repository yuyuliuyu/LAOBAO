...
<body>
    <div class="mini-fit">
        <div id="grid" class="mini-datagrid" style="width:100%;height:100%;" 
             url="../check/overtime_sub!jsonlist.action" idField="id" multiSelect="true" 
            ...
            <div property="columns">
                ...
                <div field="auditName" width="100" headerAlign="center" align="center" >审核人</div>
                <div field="auditStatus" width="80" headerAlign="center" align="center" >审核状态</div>
                <div field="auditDate" width="160" headerAlign="center" align="center" >审核时间</div>
    ...
    <script type="text/javascript">
        ...
        function view(id) {
        	mini.open({
					url : "../check/overtime_sub!viewOption.action?id=" + id,
					title : "查看审核意见",
					width : 600,
					height : 320,
					/* allowResize:false, */
