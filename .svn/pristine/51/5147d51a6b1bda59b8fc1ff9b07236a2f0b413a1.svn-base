...
<body>
	<div class="mini-toolbar" style="padding:0px;border-top:0;border-left:0;">
     ...
     <div class="mini-toolbar" style="padding:0px;border-top:0;">
   		<table style="width:100%;">
       		<tr>
               <td style="width:100%;">
               		<tags:hasPerm value="../empdata/pt_job!add.action">
                   <a class="mini-button" iconCls="icon-add" onclick="add()">增加</a>
                   </tags:hasPerm>
                   <tags:hasPerm value="../empdata/pt_job!edit.action">
                   <a class="mini-button" iconCls="icon-edit" onclick="edit()">编辑</a>
                   </tags:hasPerm>
                   <tags:hasPerm value="../empdata/pt_job!remove.action">
                   <a class="mini-button" iconCls="icon-remove" onclick="remove()">删除</a>
                   </tags:hasPerm>
                   <tags:hasPerm value="../empdata/pt_job!overptjob.action">
    ...
    <script type="text/javascript">
        ...
        function edit() {
        	 ...
        	 if (row) {
        		 if(row.state==0){
        			 var date2=Date.parse(row.endTime);
        			 var date1=Date.parse(new Date().format('yyyy-MM-dd'));
        			 var date=date1-date2;
        			 var time=date/(24*3600*1000);
        			 if(time>7){
        				 mini.alert("超过一周后不能编辑！");
        				 return;
        			 }
        		 }
       			 mini.open({
