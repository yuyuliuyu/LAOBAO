...
<body>
    ...
    <div class="mini-toolbar" style="padding:0px;border-top:0;">
	   	<table style="width:100%;">
		    <tr>
			    <td style="width:100%;">
			    	<tags:hasPerm value="../empdata/abroad!add.action">
				    <a class="mini-button" iconCls="icon-add" onclick="add()">增加</a>
				    </tags:hasPerm>
				    <tags:hasPerm value="../empdata/abroad!edit.action">
				    <a class="mini-button" iconCls="icon-edit" onclick="edit()">编辑</a>
				    </tags:hasPerm>
				    <tags:hasPerm value="../empdata/abroad!remove.action">
				    <a class="mini-button" iconCls="icon-remove" onclick="remove()">删除</a>
				    </tags:hasPerm>
				    <tags:hasPerm value="../empdata/abroad!overAbroad.action">
	...
	<input type="hidden"  name="flag" id="flag" value="${flag}" />
   	<div class="mini-fit">
   		<div id="grid" class="mini-datagrid" style="width:100%;height:100%;" 
         	 url="../personnel/abroad!getListData.action" idField="id" multiSelect="true" 
	         ...
	         <div property="columns">
		         ...
		         <div field="goalPiace"width="100" headerAlign="center" align="left">出行国家</div>
		         <div type="comboboxcolumn" field="abroadGoal" width="100" headerAlign="center" align="center">出行目的
			   		<input property="editor" class="mini-combobox" url="../system/dectionary!listjson.action?id=402881955c47d5b4015c48bfdeef0011" textField="dicname" valueField="dicvalue"/>
			   	 </div>
		         <div type="comboboxcolumn" field="abroadCase" width="100" headerAlign="center" align="center">出国类型
			   		<input property="editor" class="mini-combobox" url="../system/dectionary!listjson.action?id=402881955c47d5b4015c48c012dc0012" textField="dicname" valueField="dicvalue"/>
			   	 </div>
		         <div type="comboboxcolumn" field="idType" width="100" headerAlign="center" align="center">证件类型
			   		<input property="editor" class="mini-combobox" url="../system/dectionary!listjson.action?id=402881935ba8c785015ba8d9d7c0000b" textField="dicname" valueField="dicvalue"/>
			   	 </div>
		         <div field="idNum"width="100" headerAlign="center" align="left">证件号码</div>
		         ...
		         <div type="comboboxcolumn" field="status" width="100" headerAlign="center" align="center">状态
                 	<input property="editor" class="mini-combobox" data="[{id:1, text:'出行中'},{id:0, text:'出行结束'}]"/>
                 </div>
	         </div>
  		</div>
	</div>
    <script type="text/javascript">
      ...
      //***************添加方法**********************//
        function add() {
    			 ...
    			 mini.open({
    	                url : "../personnel/abroad!add.action?personId=${personId}",
    	                title : "添加信息",
    	                width : 770,
    	                height : 540,
    	                /* allowResize : false, */
    	  ...
    	  function edit() {
         	 ...
         	 if (row) {
          		mini.open({
  	                url : "../personnel/abroad!add.action?personId=${personId}&id="+row.id,
  	                title : "编辑人员信息",
  	                width : 900,
  	                height : 600,
  	...
  	function remove() {
  		...
  		if (rows.length > 0) {
  				if (confirm("确定删除选中记录？")) {
  					...
  					var sid = ids.join(',');
  					$.ajax({
  					url : "../personnel/abroad!remove.action?ids=" + sid,
  					type : "post",
  	 ...
  	 function overAbroad() {
		 ...
		 mini.open({
                url : "../personnel/abroad!finish.action",
                title : "添加信息",
                width : 770,
                height : 540,
                /* allowResize : false, */
  	...
  	function onKeyEnter(e) {
  		search('jobNumber,name,goalPiace','jobNumber,name,goalPiace');
    }
