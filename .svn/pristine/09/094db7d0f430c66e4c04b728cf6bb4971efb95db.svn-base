...
<body>
    <div class="mini-splitter" style="width:100%;height:100%;" borderStyle="border:0">
        ...
        <div showCollapseButton="true">
                ...
                <table style="width:100%;">
                    <tr>
                        <td style="width:100%;">
                            ...
                            <a id="searchButton"class="mini-button" iconCls="icon-search" onclick="searchByTime('name,sign','name,sign')">查询</a>
            ...
            <div class="mini-fit">
                <div id="grid" class="mini-datagrid" style="width:100%;height:100%;" url="../salary/salary_items!getSalaryGroupWageListData.action" pageSize="20"
    ...
    <script type="text/javascript">
        ...
        function addWage() {
            if (tree) {
                ...
                if (node) {
                    ...
                    tab.url = "../salary/salary_items!groupAllotAdd.action?companyId="+branchId+"&depId="+getSelectedNode(node);
                    tabs.addTab(tab);
                    tabs.activeTab(tab);
                } else {
                    mini.alert("请选择公司");
        ...
        function editWage() {
            ...
            if (row) {
                ...
                tab.title = id;
                tab.showCloseButton = true; 
                tab.url = "../salary/salary_items!groupAllotEdit.action?id=" + row.id;
                tabs.addTab(tab);
                tabs.activeTab(tab);
            } else {
                mini.alert("请选中一条记录！");
            ...
            if (rows.length == 0) {
                ...
                mini.confirm("确定要删除吗？", "提醒", function(action) {
                    if (action == "ok") {
                        ...
                        $.ajax({
                            url: "../salary/salary_items!removeToGroupWage.action",
                            type: "POST",
                            data: {
                                ids : ids
                            },
        ...
        function addGs() {
            ...
            tab.title = id;
            tab.showCloseButton = true; 
            tab.url = "../salary/formula!list.action";
            tabs.addTab(tab);
            tabs.activeTab(tab);
        }
    </script>
