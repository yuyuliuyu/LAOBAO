...
<body>
	            ...
	            <div class="mini-toolbar" style="padding:0px;border-top:0;">
	       			 <table style="width:100%;">
			                ...
			                <td style="width:100%;">
			                    ...
			                    <tags:hasPerm value="../personnel/personnel!onpost.action">
			                	<a class="mini-button" iconCls="icon-tip" onclick="onpost()">办理上岗</a>
			                	</tags:hasPerm>
			                </td>
	            		 </tr>
	        		</table>
    ...
    <script type="text/javascript">
        ...
        function onpost() {
            ...
            if (row) {
                mini.open({
                    url : "../personnel/change!onpost.action?personId="+row.id,
                    title : "上岗",
                    width : 770,
                    height : 540,
                    /* allowResize : false, */
