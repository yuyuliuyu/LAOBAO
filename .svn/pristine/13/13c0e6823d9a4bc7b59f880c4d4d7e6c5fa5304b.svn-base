...
<body>
	            ...
	            <div class="mini-toolbar" style="padding:0px;border-top:0;">
	       			 <table style="width:100%;">
			                ...
			                <td style="width:100%;">
			                    ...
			                    <a class="mini-button" iconCls="icon-user" onclick="partyuse()">党费使用</a>  
			                </td>
	            		 </tr>
	        		</table>
	    		</div>
	    		<div id="grid1" class="mini-datagrid" style="width:100%;height:94%;"showTreeIcon="true"
		             treeColumn="name" idField="did" parentField="pid" resultAsTree="false" allowResize="false" expandOnLoad="true">
		                <div property="columns">
	                        ...
	                        <div field="name" id ="name" name = "name"width="100" headerAlign="center" align="left">年份</div> 
	                        <div field="name" id ="name" name = "name"width="100" headerAlign="center" align="left">月份</div> 
	                        <div field="name" id ="name" name = "name"width="100" headerAlign="center" align="left">金额</div> 
	                        <div field="name" id ="name" name = "name"width="100" headerAlign="center" align="left">一线情况</div> 
	                        <div field="name" id ="name" name = "name"width="100" headerAlign="center" align="left">党内状态</div> 
	                        <div field="name" id ="name" name = "name"width="100" headerAlign="center" align="left">党内职位</div> 
    ...
    grid.load();
        function add() {
    			 ...
    			 mini.open({
    	                url : "../organiz/party_manager!dfadd.action",
    	                title : "添加信息",
    	                width : 770,
    	                height : 540,
    	                /* allowResize : false, */
    	...
    	function partyuse(){
    		window.location.href="../organiz/party_manager!dfsylist.action";
    	} 
