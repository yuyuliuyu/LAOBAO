...
public class CareerDaoImpl extends BaseDaoImpl<Career, String> implements CareerDao{
	...
	public HashMap<String, Object> getListData(Pager pager, String searchData,String depIds) {
		...
		.append(" JPH.JOB_DUTIES,JPH.PERFORMANCE,JPH.BEGINDATE,JPH.ENDDATE,JPH.REMARK,JPH.STATUS,JPH.PROVE,JPH.JOB_LEVEL ")
	...
	public List<Object[]> getExceptData(String thePersonId) {
		StringBuilder sql=new StringBuilder()
		.append("  select jph.* from jc_profession_history jph  ")
		.append("  WHERE jph.PERSON_ID='"+thePersonId+"'")
		;
