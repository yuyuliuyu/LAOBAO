    ...
    <form id="form1" method="post">
        ...
        <table cellpadding="0" cellspacing="0" border="0" class="addtable" width="90%" align="center">
            ...
            <tr>
                ...
                <td class="list_right_box">
                    <input class="mini-datepicker" format="yyyy-MM-dd"
					name="leaveDate" id="leaveDate" requiredErrorText="不能为空" style="width: 90%" msg="日期格式不正确" allowInput="false"
            ...
            <tr>
                ...
                <td class="list_right_box">
                    <input id="leaveCause" name="leaveCause" required="true" requiredErrorText="不能为空" class="mini-combobox" style="width:90%;" value="${dimi.leaveCause}"  textField="dicname" valueField="dicvalue"
                 		url="../system/dectionary!listjson.action?id=402885af5d62b265015d63f0541f004f" showNullItem="true" emptyText="请选择..." nullItemText="请选择..." />
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td class="list_right_box" >
                     <input name="approver" id="approver" class="mini-textarea" value="${approver}" readonly="true"
                            width="90%"/>
                </td>
