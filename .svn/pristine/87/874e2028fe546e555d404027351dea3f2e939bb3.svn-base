...
<body>
                ...
                <tr>
                    ...
                    <td class="list_right_box" width="30%">
                        <input id="educationLever" name="educationLever" class="mini-combobox" style="width:90%;" value="${edu.educationLever}"  textField="dicname" valueField="dicvalue"
		                   		required="true" url="../system/dectionary!listjson.action?id=402881a05b650042015b6617c989002f" showNullItem="true" emptyText="请选择..." nullItemText="请选择..." />
                    </td>  
                    ...
                    <td class="list_right_box" width="30%">
                        <input id="degree" name="degree" class="mini-combobox" style="width:90%;" value="${edu.degree}"  textField="dicname" valueField="dicvalue"
		                   		required="true" url="../system/dectionary!listjson.action?id=402881a05b650042015b663e8700003f" showNullItem="true" emptyText="请选择..." nullItemText="请选择..." />
                    </td> 
                </tr>
                ...
                <tr>
                    ...
                    <td class="list_right_box" width="30%">
                        <input id="isAllday" name="isAllday" class="mini-combobox" style="width:90%;" value="${edu.isAllday}"  textField="dicname" valueField="dicvalue"
		                   		required="true" url="../system/dectionary!listjson.action?id=402881935b840948015b84ed0d020022" showNullItem="true" emptyText="请选择..." nullItemText="请选择..." />
                    </td>  
                    ...
                    <td class="list_right_box" width="30%">
                        <input id="degreeType" name="degreeType" class="mini-combobox" style="width:90%;" value="${edu.degreeType}"  textField="dicname" valueField="dicvalue"
		                   		required="true" url="../system/dectionary!listjson.action?id=402881935b840948015b8510bba9002a" showNullItem="true" emptyText="请选择..." nullItemText="请选择..." />
                    </td> 
                </tr>
	...
	function onOk(){
       	...
       	var entranceDate = mini.get("entranceDate").getValue();
       	var graduateDate = mini.get("graduateDate").getValue();
       	if(entranceDate > graduateDate){
       		mini.alert("毕业时间不能比入学时间早！");
       		return;
       		}
