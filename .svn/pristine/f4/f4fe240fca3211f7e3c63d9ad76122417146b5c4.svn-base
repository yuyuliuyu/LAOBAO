...
public class SoldierBackDaoImpl extends BaseDaoImpl<SoldierBack, String> implements SoldierBackDao{
	...
	public List<Object[]> getExceptData(String thePersonId) {
		StringBuilder sql=new StringBuilder()
		.append("  SELECT JSB.ID,TO_CHAR(JSB.INSOL_DATE,'YYYY-MM-DD'),TO_CHAR(JSB.OUTSOL_DATE,'YYYY-MM-DD'),JSB.SOL_TYPE,JSB.SOL_LEVEL,JSB.SOL_DUTY,JSB.SOL_RANK,JSB.TROOPS,JSB.REMARK ")
		.append("  FROM JC_SOLDIER_BACK JSB   ")
		.append("  WHERE JSB.PERSON_ID='"+thePersonId+"'")
		;
