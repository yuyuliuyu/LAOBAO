  ...
  <body>
	...
	<div class="mini-fit">
        ...
        <table cellpadding="0" cellspacing="0" border="0" class="addtable" width="90%" align="center">
                ...
                <tr>
               		<td align="left" class="list_left_box1"  height="20px"  width="80px"><b>招聘要求：</b></td> 
                ...
                <tr>
                   <td class="list_left_box1" valign="top">编号：</td>
                    ...
                    <td class="list_left_box1" valign="top"  width="80px">用工日期：</td>
                    <td class="list_right_box">
                ...
                <tr>
                   <td class="list_left_box1" valign="top">需求部门：</td>
                    <td class="list_right_box">
                        <input name="xh" id="xh" class="mini-textbox" value="${cd.xh}"  width="100%" />
                    </td> 
                    <td class="list_left_box1" valign="top">需求岗位：</td>
                    <td class="list_right_box">
                        <input name="xh" id="xh" class="mini-textbox" value="${cd.xh}"  width="100%" />
                    </td>   
                </tr> 
                <tr>
                   <td class="list_left_box1" valign="top">需求人数：</td>
                    <td class="list_right_box">
                        <input name="xh" id="xh" class="mini-textbox" value="${cd.xh}"  width="100%" />
                    </td> 
                    <td class="list_left_box1" valign="top">最晚到岗时间：</td>
                    <td class="list_right_box">
                       <input class="mini-datepicker" format="yyyy-MM-dd" 
									name="date" style="width: 96%" msg="日期格式不正确" allowInput="false"
									 value="${laweFormArchfiling.date}"/>
                ...
                <tr>
                   <td class="list_left_box1" valign="top">岗位要求：</td>
                    <td class="list_right_box" colspan="3">
  					<textarea name="xh" id="xh" class="mini-textarea" value="${cd.xh}" emptyText="请输入备注" style="width: 100%;height: 50px"></textarea>
                    </td>  
                </tr>
