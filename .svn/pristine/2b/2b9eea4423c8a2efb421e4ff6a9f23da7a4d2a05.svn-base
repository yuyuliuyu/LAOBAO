...
<body>
    ...
    <script type="text/javascript">
        ...
        function searchS() {
            dynamicTable('jobNumber,staffName,empType,laowu,salaryPeriod','jobNumber,staffName,empType,laowu,salaryPeriod');
        }
        ...
        function dynamicTable(name,attr) {
            ...
            $.ajax({
                url: "../salary/salary_pager!getDeptListData.action?pageIndex="+pageIndex+"&pageSize="+pageSize,
                type: "POST",
                data : {
                    searchData : ss
                },
