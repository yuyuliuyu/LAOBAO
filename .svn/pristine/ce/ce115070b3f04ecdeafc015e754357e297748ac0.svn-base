...
public class BaseDaoImpl<T, PK extends Serializable> extends
    ...
    public synchronized T get(Object... cList) {
        Criteria criteria = getSession().createCriteria((Class)ThreadLocalHolder.getEntMap().get("entityClass"));
...
//    }
    ...
    public Pager findPager(Pager pager, Criteria criteria) {
        ...
        Class clz =  (Class)ThreadLocalHolder.getEntMap().get("entityClass");
        try{
        ...
        ClassMetadata classMetadata = getSessionFactory().getClassMetadata(clz);
