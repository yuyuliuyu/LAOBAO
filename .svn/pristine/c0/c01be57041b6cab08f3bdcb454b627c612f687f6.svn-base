...
/**
 * QxDepartment entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "QX_DEPARTMENT")
public class QxDepartment extends BaseEntity implements java.io.Serializable {

    private static final long serialVersionUID = 6349640437969973602L;
    // Fields
   /* @Id
    ...
    /** full constructor */
    public QxDepartment(String name, String description,
            String parent) {
        this.name = name;
