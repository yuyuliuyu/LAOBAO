...
<body>
    ...
    <div class="mini-toolbar" style="text-align:center;padding-top:8px;padding-bottom:8px;" borderStyle="border:0;">
        <a class="mini-button" onclick="onOKClose()" style="width:60px;margin-right:20px;" iconCls="icon-remove">删除</a>
    ...
    <script type="text/javascript">
        ...
        function onOKClose() {
            ...
            mini.confirm("确定要删除选中的薪资组吗？", "提醒", function(action) {
                if (action == "ok") {
                    window.parent.loading();
                    $.ajax({
                        url : "../salary/salary_items!removePersonalGroupListData.action",
                        type : "post",
                        data : {
                            ids : ids
                        },
