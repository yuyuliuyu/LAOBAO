...
<body>
    <div class="mini-toolbar" style="border-left:0;padding:0px;">
		<table style="width:100%;">
			<tr>
				<td>
					<a class="mini-button" iconCls="icon-add" onclick="add(0)">新增模版</a>
					<a class="mini-button" iconCls="icon-add" onclick="add(1)">新增</a>
					<a class="mini-button" iconCls="icon-edit" onclick="edit()">编辑</a>
					<a class="mini-button" iconCls="icon-remove" onclick="remove()">删除</a>
					<a class="mini-button" iconCls="icon-upload" onclick="exportContentInfo()">导出</a>
					<a class="mini-button" iconCls="icon-search" onclick="finddemo()">模版列表</a>
				</td>
			</tr>
		</table>
	</div>
    <div class="mini-fit">
        <div id="grid" class="mini-datagrid" style="width:100%;height:100%;" 
            ...
            <div property="columns">
                ...
                <div field="daytime" id="daytime" name="daytime" width="40" headerAlign="center" align="center" >白</div>
                <div field="night" id="night" name="night" width="40" headerAlign="center" align="center" >夜</div>
                <div field="offDuty" id="offDuty" name="offDuty" width="40" headerAlign="center" align="center" >下</div>
                <div field="centre" id="centre" name="centre" width="40" headerAlign="center" align="center" >中</div>
                <div field="overseas" id="overseas" name="overseas" width="40" headerAlign="center" align="center" >外</div>
                <div field="rest" id="rest" name="rest" width="40" headerAlign="center" align="center" >休</div>
                <div field="allDay" id="allDay" name="allDay" width="40" headerAlign="center" align="center" >全</div>
                <div field="take" id="take" name="take" width="40" headerAlign="center" align="center" >带</div>
                <div field="flip" id="flip" name="flip" width="40" headerAlign="center" align="center" >弹</div>
                <div field="call" id="call" name="call" width="40" headerAlign="center" align="center" >调</div>
                <div field="changes" id="changes" name="changes" width="40" headerAlign="center" align="center" >换</div>
                ...
                <div field="study" id="study" name="study" width="40" headerAlign="center" align="center" >学</div>
                <div field="very" id="very" name="very" width="40" headerAlign="center" align="center" >非</div>
                <div field="business" id="business" name="business" width="40" headerAlign="center" align="center" >公</div>
                <div field="evection" id="evection" name="evection" width="40" headerAlign="center" align="center" >差</div>
                <div field="team" id="team" name="team" width="40" headerAlign="center" align="center" >团</div>
                <div field="borrow" id="borrow" name="borrow" width="40" headerAlign="center" align="center" >借</div>
                <div field="retreat" id="retreat" name="retreat" width="40" headerAlign="center" align="center" >退</div>
                <div field="diction" id="diction" name="diction" width="40" headerAlign="center" align="center" >辞</div>
                <div field="leave" id="leave" name="leave" width="40" headerAlign="center" align="center" >离</div>
                ...
                <div field="outHour" id="outHour" name="outHour" width="80" headerAlign="center" align="center" >出勤小时数</div>
                <div field="delayedHour" id="delayedHour" name="delayedHour" width="80" headerAlign="center" align="center" >延时小时数</div>
    ...
    <script type="text/javascript">
        ...
        grid.load();
        function finddemo(){
        	grid.load({contentName:"mb"});
        }
        //新增
		function add(id) {
			mini.open({
				url : "../check/content!add.action?contentName="+id,
				title : id==0? "新增考勤模板" : "新增考勤内容信息",
				width : 900,
				height : 660,
				allowResize : false,
				onload : function() {
