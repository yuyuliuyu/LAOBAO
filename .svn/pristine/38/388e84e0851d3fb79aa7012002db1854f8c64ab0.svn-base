...
<body>
                ...
                <table style="width:100%;">
                    <tr>
                        <td style="width:100%;">
                            ...
                            <a class="mini-button" iconCls="icon-edit" onclick="fuli()">福利类型</a>
                        </td>
                    </tr>
                </table>
            </div>
            <div class="mini-fit">
                <div id="grid" class="mini-datagrid" style="width:100%;height:100%;" url="../salary/salary_record!getSalaryStandard.action" pageSize="20"
                    ...
                    <div property="columns">
                        ...
                        <div field="" width="100" headerAlign="left" align="left">工号</div>
                        <div field="" width="100" headerAlign="left" align="left">姓名</div>
                        <div field="" width="100" headerAlign="left" align="left">公司</div>
                        <div field="" width="100" headerAlign="left" align="left">部门</div>
                        <div field="" width="100" headerAlign="left" align="left">福利名称</div>
                        <div field="" width="100" headerAlign="left" align="left">年龄</div>
                        <div field="" width="100" headerAlign="left" align="left">联系方式</div>
                        <div field="" width="100" headerAlign="left" align="left">岗位</div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script type="text/javascript">
        ...
        function add() {
            mini.open({
                url : "../salary/salary_welfare!add.action?id=",
                title : "员工福利增加",
                width : 540,
                height : 320,
                onload : function() {
        ...
        function fuli() {
            ...
            tab.url = "../salary/salary_welfare!type.action";
            tabs.addTab(tab);
            tabs.activeTab(tab);
        }
