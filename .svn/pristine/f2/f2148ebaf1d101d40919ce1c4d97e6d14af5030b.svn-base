...
<body>
	            ...
	            <div class="mini-toolbar" style="padding:0px;border-top:0;">
	       			 <table style="width:100%;">
			                ...
			                <td style="width:100%;">
			                    ...
			                    <a class="mini-button" iconCls="icon-edit" onclick="edit1()">员工自我编辑</a>
			                    <a class="mini-button" iconCls="icon-search" onclick="look()">查看员工详细信息</a>
			                    <a class="mini-button" iconCls="icon-search" onclick="khxx()">实习生考核信息</a>
			                    <!-- <a class="mini-button" iconCls="icon-tip" onclick="khxx()">考核评价申请</a>
			                    <a class="mini-button" iconCls="icon-tip" onclick="khxx()">考核评价审核</a> -->
			                    <!-- <a class="mini-button" iconCls="icon-tip" onclick="jdjg()">实习生鉴定申请</a>
			                    <a class="mini-button" iconCls="icon-tip" onclick="jdjg()">实习生鉴定审核</a> -->
    ...
    <script type="text/javascript">
        ...
        function edit() {
            ...
            if (row) {
            	mini.open({
                    url : "../personnel/practice!edit.action?flag=0&personId="+row.id,
                    title : "编辑人员信息",
                    width : 900,
                    height : 600,
                    onload : function() {
      ...
      //人员管理基础数据修改
        function edit1() {
            ...
            if (row) {
            	mini.open({
                    url : "../personnel/practice!edit1.action?flag=0&personId="+row.id,
                    title : "编辑人员信息",
                    width : 900,
                    height : 600,
                    onload : function() {
