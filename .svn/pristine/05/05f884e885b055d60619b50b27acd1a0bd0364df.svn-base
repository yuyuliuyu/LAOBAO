...
/**
 * 维护员工月平均工资
 * XcMonthSalary entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "XC_MONTH_SALARY")
public class MonthSalary extends BaseEntity implements java.io.Serializable {

    private static final long serialVersionUID = 4779870225388145192L;
    private String staffId;// 员工ID
    private String averageSalary;// 平均工资
    private Integer effectiveYear;// 年
    ...
    @Column(name = "EFFECTIVE_YEAR", length = 4)
