...
<body>
	            ...
	            <div class="mini-toolbar" style="padding:0px;border-top:0;">
	       			 <table style="width:100%;">
	           			 <tr>
			                <td style="width:100%;">
			                	<tags:hasPerm value="../empdata/attention!add1.action">
			                    <a class="mini-button" iconCls="icon-add" onclick="add()">增加</a>
			                    </tags:hasPerm>
			                    <tags:hasPerm value="../empdata/attention!edit1.action">
			                    <a class="mini-button" iconCls="icon-edit" onclick="edit()">编辑</a>
			                    </tags:hasPerm>
			                    <tags:hasPerm value="../empdata/attention!remove1.action">
	    ...
	    <div class="mini-fit">
	    		<div id="grid" class="mini-datagrid" style="width:100%;height:100%;" 
             		 url="../empdata/attention!getTalkListData.action" idField="id" multiSelect="true" 
		        	...
		        	<div property="columns">
	                	...
	                	<div type="comboboxcolumn" field="talkType" width="100" headerAlign="center" align="center">访谈类型
                   			<input property="editor" class="mini-combobox" url="../system/dectionary!listjson.action?id=402881955c23ab27015c24870b6d000c" textField="dicname" valueField="dicvalue"/>
                		</div>
                		<div field="talkDate" width="100" headerAlign="center" align="center">访谈时间</div>
	                	<div field="jobNumber2" width="100" headerAlign="center" align="center">访谈人</div>
	                	<div field="talkMessage" width="200" headerAlign="center" align="center">访谈信息</div>
	                </div>
       		 	</div>
	</div>
    ...
    <script type="text/javascript">
        ...
        function add() {
    			 ...
    			 mini.open({
    	                url : "../empdata/attention!talkadd.action",
    	                title : "添加信息",
    	                width : 770,
    	                height : 540,
    	                /* allowResize : false, */
        ...
        function edit() {
         	 ...
         	 if (row) {
          		mini.open({
                     	 url : "../empdata/attention!talkadd.action?id="+row.id,
                       title : "编辑人员信息",
             		     width : 900,
              		 height : 600,
               		 onload : function() {
      	...
      	function remove() {
      		...
      		if (rows.length > 0) {
      				if (confirm("确定删除选中记录？")) {
      					...
      					var sid = ids.join(',');
      					$.ajax({
      					url : "../empdata/attention!removetalk.action?ids=" + sid,
      					type : "post",
