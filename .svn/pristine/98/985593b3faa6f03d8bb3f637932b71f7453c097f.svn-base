...
<body>
            ...
            <tr>
                <td style="width:220px;padding-left:20px;">单位：
                    <input id="company" class="mini-combobox" style="width:170px;" textField="name" valueField="id" 
				        onvaluechanged="onCompanyChanged" url="../basis/branch!getBranchappList.action" popupWidth="auto"
				        showNullItem="false"/> 
                </td>
                <td style="width:220px;padding-left:20px;">部门：
                    <input id="department" class="mini-combobox" popupWidth="auto" popupMinWidth="170" style="width:170px;" textField="name" valueField="id" showNullItem="false"/>
                </td>
                ...
                <td style="white-space:nowrap;">
                    <a id="searchButton" class="mini-button" iconCls="icon-search" onclick="searchInfo()" onenter="onKeyEnter">查询</a>
                </td>
    ...
    <div class="mini-fit">
        <div id="grid" class="mini-datagrid" style="width:100%;height:100%;" 
            ...
            <div property="columns">
                ...
                <div field="deptall" id="deptall" name="deptall" width="120" headerAlign="center" allowSort="true">deptinfo</div>
                ...
                <div field="specificPost" width="80" headerAlign="center" align="center" >具体岗位</div>
    ...
    <script type="text/javascript">
	    ...
	    function audit(){ 
        	grid.selectAll(true);
			var rows = grid.getSelecteds();
			var yearMonth = mini.get("yearMonth");
			if (yearMonth.getValue() == "") {
				mini.alert("请输入审核年月");
				return;
			}
			if (rows.length >= 1) {  
			mini.open({
					//url : "../check/audit_infos!showApprove.action?id="+ rows[0].deptall+"&yearMonth="+mini.get("yearMonth").getValue()+"&companyId="+mini.get("company").getValue(),
					url : "../check/audit_infos!showApprove.action?id="+ department.getValue()+"&yearMonth="+mini.get("yearMonth").getValue()+"&companyId="+mini.get("company").getValue(),
					title : "填写审核意见",
					width : 750,
					height : 410,
					allowResize : false,
