...
<body>
   	    ...
   	    <div id="table11">
        	<table id="table1" cellpadding="0" cellspacing="0" border="0" class="addtable" width="100%">
                ...
                <tr>
                    ...
                    <td class="list_left_box1" valign="top">上岗时间：</td>
                	<td class="list_right_box">
                        <input class="mini-datepicker" format="yyyy-MM-dd"
								required="true"	name="changedate" id="changedate" style="width: 90%" msg="日期格式不正确" allowInput="false"
									 value="${change.changedate}"/>
                    </td> 
                </tr>
                
                <tr>
                    <td class="list_left_box1" valign="top" width="15%">分配部门：</td>
                    <td class="list_right_box" width="30%">
                        <input id="dep2" name="dep2" class="mini-buttonedit" onbuttonclick="onButtonEdit" width="90%"
                                required="true" value="${change.dep2}" allowInput="false"/> 
                   	</td>
                   	<td class="list_left_box1" valign="top" width="15%">分配公司：</td>
                   	<td class="list_right_box" width="30%">
                   		<!-- 只显示用 -->
                ...
                <tr>
                	<td class="list_left_box1" valign="top" width="15%">分配具体岗位：</td>
                    <td class="list_right_box" width="30%">
                        <input id="spPost2a" name="spPost2" class="mini-buttonedit" onbuttonclick="onButtonEdit1" width="90%"
                                required="true" value="${change.spPost2}"allowInput="false"/> 
                    	</td>
                    <td class="list_left_box1" valign="top" width="15%">分配标准岗位：</td>
                    <td class="list_right_box" width="30%">
                        <input id="spanPost2a" name="spanPost2"  class="mini-buttonedit" value="${change.spanPost2}" 
                                required="true" readonly="true" width="90%"/>
                    </td> 
                ...
                <tr>
                    ...
                    <td class="list_right_box" colspan="3">
                        <input id="remark" name="remark" class="mini-textarea" value="${branch.remark}"  maxlength="500"style="width: 96%;height:50px"/>
                    </td> 
                </tr>
        </table>
     </div>
	...
	function onOk(){
        ...
        //strut令牌
        $.ajax({
            url: "../personnel/change!saveOrUpdateOnpost.action",
            data:{
            	formdata:json,
            },
            success: function (text) {
