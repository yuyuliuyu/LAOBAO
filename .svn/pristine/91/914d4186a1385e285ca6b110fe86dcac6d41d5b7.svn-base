...
<body>
	<div class="mini-fit">
		<div class="mini-splitter" style="width:100%;height:100%;" handlerSize="9">
            ...
            <div size="16%" showCollapseButton="true">
                ...
                <div class="mini-fit">
                    <ul id="tree1" class="mini-tree" url="../basis/branch!getTreeListByUser.action" style="width:100%;height:100%;" onNodeclick="onNodeclick"
            ...
            <div showCollapseButton="false">
	            ...
	            <div class="mini-toolbar" style="padding:0px;border-top:0;">
	       			 <table style="width:100%;">
	           			 <tr>
			                <td style="width:100%;">
			                    <a class="mini-button" iconCls="icon-add" onclick="addposition()">增加</a>
	    		...
	    		<div class="mini-fit">
					<div id="grid" class="mini-datagrid" style="width:100%;height:100%;" 
						...
						<div property="columns">
	                        ...
	                        <div type="comboboxcolumn" field="state" width="100" headerAlign="center" align="center">生效状态
    ...
    <script type="text/javascript">
        ...
        function addpost() {
 			 mini.open({
 	                url : "../post/post!dutylistadd.action",
 	                title : "添加信息",
 	                width : 600,
 	                height : 500,
 	                /* allowResize : false, */
        ...
        function addposition() {
        	...
        	if(node){
        		var cid = node.id;
    			 mini.open({
    	                url : "../post/position!add.action?cid="+cid+"&flg=true",
    	                title : "添加岗位信息",
    	                width : 770,
    	                height : 600,
    	                /* allowResize : false, */
        ...
        function editposition() {
            ...
            if (row) {
                mini.open({
                    url : "../post/position!edit.action?id="+row.id+"&flg=true",
                    title : "编辑岗位信息",
                    width : 770,
    	            height : 600,
                    /* allowResize : false, */
        ...
        function lookposition() {
            ...
            if (row) {
                mini.open({
                    url : "../post/position!look.action?id="+row.id+"&flg=false",
                    title : "查看岗位信息",
                    width : 770,
    	            height : 600,
                    /* allowResize : false, */
        ...
        function removeposition() {
        	...
        	mini.confirm("您确定要删除该信息吗？","提醒",function(action){
                if(action=="ok"){
                    $.ajax({
                        url : "../post/position!delete.action?id=" + row.id,
                        type:'post',
                        success: function (text) {
                            if(text=="success"){
