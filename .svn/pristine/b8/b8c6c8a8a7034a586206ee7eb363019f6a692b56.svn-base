...
/**
 * 缴费基数过程表
 * XcSalaryBaseProcess entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "XC_SALARY_BASE_PROCESS")
public class SalaryBaseProcess extends BaseEntity implements java.io.Serializable {

    private static final long serialVersionUID = 3086779237890184098L;
