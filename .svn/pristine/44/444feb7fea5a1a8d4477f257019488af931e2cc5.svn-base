...
<body>
    ...
    <div class="mini-fit">
        <table style="width:100%;height: 100%;">
            ...
            <tr>
                <td style="width:100%;height: 100%;text-align: center;margin-top:10px;" valign="top">
        ...
        function dynamicTable(preType) {
            ...
            $.ajax({
                ...
                success: function(text) {
                    ...
                    // 设置打印参数
                    LODOP.PRINT_INITA(0,0, "380mm","520mm", "${data}_员工工资单");
                    LODOP.SET_PRINT_PAGESIZE(2,"380mm","520mm", "");// 纸张大小

                    var strBodyStyle="<style>"+document.getElementById("style1").innerHTML+"</style>";

                    // 标题
                    var title = '<div class="g-title" id="m-top-title"><p>青岛港国际物流有限公司员工月度考勤表</p></div>';
                    // 标题每页都存在
