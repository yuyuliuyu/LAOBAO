...
<body>
    ...
    <div class="mini-fit">
       <div class="mini-toolbar" style="padding:0px;border-top:0;">
      	 	<table style="width:100%;">
          		<tr>
	                <td style="width:100%;">
	                    <a class="mini-button" iconCls="icon-add" onclick="add()">订立集体合同</a>
	                    <a class="mini-button" iconCls="icon-edit" onclick="edit()">变更集体合同</a>
	                    <a class="mini-button" iconCls="icon-remove" onclick="remove()">终止集体合同</a>
	                    <a class="mini-button" iconCls="icon-remove" onclick="relieve()">解除集体合同</a>
	                    <a class="mini-button" iconCls="icon-search" onclick="look()">查看集体合同</a>
	                </td>
           		 </tr>
       		</table>
   		</div>
    ...
    <script type="text/javascript">
        ...
        function edit() {
            ...
            if (row) { */
                mini.open({
                    url : "../pact/pact!changeadd.action",
                    title : "订变更集体合同",
                    width : 770,
                    height : 540,
                    /* allowResize : false, */
