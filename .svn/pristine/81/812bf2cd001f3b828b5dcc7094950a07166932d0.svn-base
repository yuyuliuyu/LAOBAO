...
/**
 * 缴费基数过程缴费单位中间表
 * XcBaseProcessCompany entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "XC_BASE_PROCESS_COMPANY")
public class BaseProcessCompany extends BaseEntity implements java.io.Serializable {

    private static final long serialVersionUID = -3090253202155005944L;
