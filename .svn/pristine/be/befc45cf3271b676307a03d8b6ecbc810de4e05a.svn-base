			...
			<table cellpadding="0" cellspacing="0" border="0" class="addtable" width="100%">
                ...
                <tr>
                    ...
                    <td class="list_right_box">
                        <input id="jobLevel" name="jobLevel" class="mini-combobox" style="width:90%;" value="${car.jobLevel}"  textField="dicname" valueField="dicvalue"
                ...
                <tr>
                    ...
                    <td class="list_right_box">
                        <input id="proDuty" name="proDuty" class="mini-combobox" style="width:90%;" value="${car.proDuty}"  textField="dicname" valueField="dicvalue"
		                   		required="true" url="../system/dectionary!listjson.action?id=402881935ba8c785015ba8e043c80011" showNullItem="true" emptyText="请选择..." nullItemText="请选择..." />
                    </td>
