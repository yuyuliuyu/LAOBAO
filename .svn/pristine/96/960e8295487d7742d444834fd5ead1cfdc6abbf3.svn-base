...
<body>
	<div id="tabs1" class="mini-tabs" activeIndex="0"  style="width:100%;height:100%;  " plain="false">
		<div title="基本设置" url="${base}jsp/icon/zhijian1.jsp" >
			
		</div>
		<div title="IQC检验流程" url="${base}jsp/icon/zhijian3.jsp" >
			
		</div>
		<div title="PQC检验流程" url="${base}jsp/icon/zhijian4.jsp">
			
		</div>
		<div title="FQC检验流程" url="${base}jsp/icon/zhijian2.jsp">
