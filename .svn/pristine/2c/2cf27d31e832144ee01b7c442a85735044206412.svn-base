               ...
               <tr>
                ...
                <tr>
                    ...
                    <td class="list_right_box" width="60%">
                    	<input field="activityName" name="activityName" id="activityName" required="true" 
							...
							width="200px" value="${activityApply.activityName}" 
							url="../template/processType.txt"/>
                    </td>
                </tr>
                <tr>
					...
					<td>
						<input name="cycleType" id="cycleType" required="true" repeatItems="3" 
							...
							width="300px" value="${activityApply.cycleType}" url="../template/using.txt"/>
					</td>
				</tr>
                <tr style="height:100px;">
                    ...
                    <td class="list_right_box" width="70%">
                        <input name="jm" id="jm" class="mini-textarea" value="${branch.jm}"
                            required="true" requiredErrorText="不能为空" vtype="maxLength:10" width="100%" height="100%"/>
                    </td>
                </tr>
            </table>
        </div>
