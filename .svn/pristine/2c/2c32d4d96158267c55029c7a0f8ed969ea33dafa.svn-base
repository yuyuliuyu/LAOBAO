  ...
  <body>
	...
	<div class="mini-fit">
        ...
        <table cellpadding="0" cellspacing="0" border="0" class="addtable" width="90%" align="center">
                ...
                <tr>
                	<td class="list_left_box1" valign="top">简称：</td>
                    <td class="list_right_box">
                        <input name="xh" id="xh" class="mini-textbox" value="${cd.xh}"
                                vtype="maxLength:50" width="100%"/>
                    </td> 
                   <td class="list_left_box1" valign="top">所属单位：</td>
                ...
                <tr>
                    ...
                    <td class="list_right_box" colspan="6" >
             	...
             	<tr> 
                   ...
                   <tr>
               		<td align="left" class="list_left_box1"  height="30px" ><b>组织属性：</b></td> 
               		<td align="left" class="list_left_box1"  colspan="5" > </td> 
                  </tr> 
                  
                <tr>
                	<td class="list_left_box1" valign="top">属地关系：</td>
                    <td class="list_right_box">
                        <input name="xh" id="xh" class="mini-textbox" value="${cd.xh}"
                                vtype="maxLength:50" width="100%"/>
                    </td> 
                   <td class="list_left_box1" valign="top">单位规模：</td>
                    <td class="list_right_box">
                        <input name="xh" id="xh" class="mini-textbox" value="${cd.xh}"
                                vtype="maxLength:20;required" width="100%"/>
                    </td>
                    <td class="list_left_box1" valign="top">经济类型：</td>
                    <td class="list_right_box">
                        <input name="xh" id="xh" class="mini-textbox" value="${cd.xh}"
                                vtype="maxLength:20;required" width="100%"/>
                    </td> 
                ...
                <tr>
                	<td class="list_left_box1" valign="top">民营科技企业标识：</td>
                    <td class="list_right_box">
                        <input name="xh" id="xh" class="mini-textbox" value="${cd.xh}"
                                vtype="maxLength:50" width="100%"/>
                    </td> 
                   <td class="list_left_box1" valign="top">法人单位标识：</td>
                    <td class="list_right_box">
                        <input name="xh" id="xh" class="mini-textbox" value="${cd.xh}"
                                vtype="maxLength:20;required" width="100%"/>
                    </td>
                    <td class="list_left_box1" valign="top">中介组织标识：</td>
                    <td class="list_right_box">
                        <input name="xh" id="xh" class="mini-textbox" value="${cd.xh}"
                                vtype="maxLength:20;required" width="100%"/>
                    </td> 
             	...
             	<tr> 
                   ...
                   <tr>
               		<td align="left" class="list_left_box1"  height="30px" ><b>联系信息：</b></td> 
               		<td align="left" class="list_left_box1"  colspan="5" > </td> 
                  </tr> 
                  
                <tr>
                	<td class="list_left_box1" valign="top">电话：</td>
                    <td class="list_right_box">
                        <input name="xh" id="xh" class="mini-textbox" value="${cd.xh}"
                                vtype="maxLength:50" width="100%"/>
                    </td> 
                   <td class="list_left_box1" valign="top">传真：</td>
                    <td class="list_right_box">
                        <input name="xh" id="xh" class="mini-textbox" value="${cd.xh}"
                                vtype="maxLength:20;required" width="100%"/>
                    </td>
                    <td class="list_left_box1" valign="top">邮编：</td>
                    <td class="list_right_box">
                        <input name="xh" id="xh" class="mini-textbox" value="${cd.xh}"
                                vtype="maxLength:20;required" width="100%"/>
                    </td> 
                   ...
                   <tr>
               		<td align="left" class="list_left_box1"  height="30px" >地址：</td> 
