	    		...
	    		<div id="grid" class="mini-datagrid" style="width:100%;height:100%;" 
            		 ...
            		 allowAlternating="true" pageSize="100" >
		                ...
		                <div property="columns">
                        	...
                        	<div type="comboboxcolumn" field="leaveCause" width="100" headerAlign="center" align="center">离职原因
                            	<input property="editor" class="mini-combobox" url="../system/dectionary!listjson.action?id=402885af5d62b265015d63f0541f004f"
                            		textField="dicname" valueField="dicvalue"/>
                        	</div>
                        	<div field="speLeaveCause" width="100" headerAlign="center" align="left">离职具体原因</div>
                        	<div field="raiseLeaveDate" width="100" headerAlign="center" align="left">提出离职时间</div>
	                        <div field="leaveDate" width="100" headerAlign="center" align="left">实际离职时间</div>
	                        <div field="approveLeaveDate" width="100" headerAlign="center" align="left">批准离职时间</div>
	                        ...
	                        <div field="remark" width="100" headerAlign="center" align="left">其他说明</div>
