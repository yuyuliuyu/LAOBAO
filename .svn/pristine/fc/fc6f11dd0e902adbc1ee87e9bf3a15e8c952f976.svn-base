...
<body>
        ...
        <div showCollapseButton="true">
            ...
            <div class="mini-fit">
                <div id="grid" class="mini-datagrid" style="width:100%;height:100%;" pageSize="20"
                    allowAlternating="true" multiSelect="true" url="../salary/salary_payment!getJsBaseSalaryDatas.action"
    ...
    <script type="text/javascript">
        ...
        function add() {
            ...
            if (node) {
                ...
                if (branchId) {
                    ...
                    tab = {};
                    tab.name = id;
                    tab.title = "增加计算缴费基数过程";
                    tab.showCloseButton = true; 
                    tab.url = "../salary/salary_insurance!baseAdd.action?companyId=" + branchId;
                    tabs.addTab(tab);
                    tabs.activeTab(tab);
                }
            } else {
       ...
       function edit() {
           ...
           tab.title = "计算缴费基数过程";
           tab.showCloseButton = true; 
           tab.url = "../salary/salary_insurance!baseEdit.action?id="+idRow+"&companyId=" + rows[0].companyId;
           tabs.addTab(tab);
           tabs.activeTab(tab);
       }
