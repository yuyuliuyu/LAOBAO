    ...
    <form id="form1" method="post">
                ...
                <tr>
                    ...
                    <td class="list_right_box" >
                         <input class="mini-datepicker" format="yyyy-MM-dd"
							required="true" id="awarddate" name="awarddate" style="width: 90%" msg="日期格式不正确" allowInput="false"
        ...
        <form id="uploaders" method="post" action="../empdata/award!uploadFile.action?id=${id}"
         ...
         请选择上传文件：
                    ...
                    <td class="list_right_box" colspan="3">
				            <input class="mini-htmlfile" id="uploadFile" name="uploadFile"  text="${award.url}" />
