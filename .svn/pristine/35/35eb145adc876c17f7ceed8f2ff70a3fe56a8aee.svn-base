...
/**
 * 缴费基数过程参与组织中间表
 * XcBaseProcessDept entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "XC_BASE_PROCESS_DEPT")
public class BaseProcessDept extends BaseEntity implements java.io.Serializable {

    private static final long serialVersionUID = -2970209371277117189L;
    private String deptId;// 部门ID
    private String salaryPaymentProcessId;// 缴费过程表ID
    private Integer type;// 标志 0:公司ID 1：部门ID
