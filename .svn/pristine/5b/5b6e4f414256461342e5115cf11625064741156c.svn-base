...
<body>
    ...
    <script type="text/javascript">
        ...
        // 岗位编制跳转到人员管理
        function onGwbzLook(deptId, positionName) {
            // 权限查找
            $.ajax({
                    ...
                    if (text !="" && text.length > 0) {
                        ...
                        if (s.indexOf("2") == -1) {
                            ...
                            if (!tab) {
                                ...
                                tab.url = "../personnel/personnel!list.action?depId="+deptId+"&positionName="+positionName;
                                tabs.addTab(tab);
                            } else tab.url = "../personnel/personnel!list.action?depId="+deptId+"&positionName="+positionName;
                            tabs.activeTab(tab);
                            tabs.reloadTab(tab);
                        }
                    }
