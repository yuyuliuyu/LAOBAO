...
<body>
    <form id="form1" method="post">
        ...
        <table cellpadding="0" cellspacing="0" border="0" class="addtable" width="100%">
                ...
                <tr>
                    <td class="list_left_box1" valign="top" width="15%">解除日期：</td>
                    <td class="list_right_box" width="30%">
                        <input name="xh" id="xh" class="mini-textbox" value="${cd.xh}"
                                vtype="maxLength:20;required" width="200px"/>
                    </td> 
                    <td class="list_left_box1" valign="top" width="15%">提出解除主体：</td>
                    <td class="list_right_box" width="30%">
                        <input name="xh" id="xh" class="mini-textbox" value="${cd.xh}"
                                vtype="maxLength:50" width="200px"/>
                    </td> 
                ...
                <tr>
                    <td class="list_left_box1" valign="top" width="15%">解除方式：</td>
                    <td class="list_right_box" width="30%">
                        <input name="xh" id="xh" class="mini-textbox" value="${cd.xh}"
                                vtype="maxLength:20;required" width="200px"/>
                    </td> 
                    <td class="list_left_box1" valign="top" width="15%">提经办人：</td>
                    <td class="list_right_box" width="30%">
                        <input name="xh" id="xh" class="mini-textbox" value="${cd.xh}"
                                vtype="maxLength:50" width="200px"/>
                    </td> 
                ...
                <tr>
                    <td class="list_left_box1" valign="top" width="15%">解除原因：</td>
                    <td class="list_right_box" width="30%">
                        <input name="xh" id="xh" class="mini-textbox" value="${cd.xh}"
