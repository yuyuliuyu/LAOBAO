...
<body>
	...
	<div class="mini-toolbar" style="padding:0px;border-top:0;">
		<table style="width:100%;">
			<tr>
				<td style="width:100%;">
					<tags:hasPerm value="../empdata/skilled_emp!add.action">
					<a class="mini-button" iconCls="icon-add" onclick="add()">增加</a>
					</tags:hasPerm>
					<tags:hasPerm value="../empdata/skilled_emp!edit.action">
			        <a class="mini-button" iconCls="icon-edit" onclick="edit()">编辑</a>
			        </tags:hasPerm>
			        <tags:hasPerm value="../empdata/skilled_emp!remove.action">
    ...
    function add() {
    	mini.open({
    	   url : "../empdata/skilled_emp!add.action?personId=${personId}",
    	   title : "添加信息",
    	   width : 770,
    	   height : 540,
    	   onload : function() {
  ...
  //***************编辑方法**********************//
	function edit() {
   	 ...
   	 if (row) {
    		mini.open({
               	 url : "../empdata/skilled_emp!add.action?personId=${personId}&id="+row.id,
                 title : "编辑人员信息",
       		     width : 900,
        		 height : 600,
         		 onload : function() {
