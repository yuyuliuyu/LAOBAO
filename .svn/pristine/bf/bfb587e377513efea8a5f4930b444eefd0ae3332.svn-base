		...
		<div showCollapseButton="flase">
				...
				<table style="width:100%;">
					<tr>
						<td>
							...
							<a class="mini-button" iconCls="icon-upload" onclick="exportMonthStatistics()">导出</a> 
						</td>
					</tr>
				</table>
			</div>
		    <div class="mini-fit">
		        <div id="grid" class="mini-datagrid" style="width:100%;height:100%;" 
		             url="../check/statistics!getMonthStatisticsData.action" idField="id" multiSelect="true" 
		            ...
		            <div property="columns">
		                ...
		                <div field="remark" width="200" headerAlign="center" align="center" >备注</div>
		            </div>
		        </div>
		    </div>
		</div>
	...
	<script type="text/javascript">
		...
		function edit() {
			...
			if (rows.length <= 0){
				...
				mini.open({
					url : "../check/statistics!editMonth.action?id=" + row.id,
					title : "修改员工月度考勤统计信息",
					width : 800,
					height : 610,
					/* allowResize:false, */
		...
		//导出月考勤统计信息集合
		function exportMonthStatistics(){
			var yearMonth = mini.get("yearMonth").getValue();
			var jobNumber = mini.get("jobNumber").getValue();
			var depIds = "";
			//如果有树
			...
			window.location.href="../check/statistics!exportMonthStatistics.action?yearMonth="+yearMonth
