...
<body>
	<div class="mini-fit">
        ...
        <table cellpadding="0" cellspacing="0" border="0" class="addtable" width="90%" align="center">
                ...
                <tr>
                    ...
                    <td class="list_right_box" width="20%">
                        <input id="empType" name="empType" class="mini-combobox" readonly="readonly" style="width:100%;" value="${information.empType}"  textField="dicname" valueField="dicvalue"
                    ...
                    <td class="list_left_box1" valign="top" rowspan="5">照片：</td>
                   	<td class="list_right_box" rowspan="5">
                   		<s:if test="information.imgpath!=null">
                    		<img id="licensepicture" src="${imgpath}" height="140" width="100"/>
                    	</s:if>
                ...
                <tr>
                    ...
                    <td class="list_right_box" width="30%">
                        <input id="onJob" name="onJob" class="mini-combobox" readonly="readonly"  style="width:100%;" value="${information.onJob}"  textField="dicname" valueField="dicvalue"
                ...
                <tr>
	                ...
	                <td class="list_right_box">
	                	<input name="jobNumber" id="jobNumber" class="mini-textbox" readonly="readonly" value="${information.jobNumber}"
	                	width="100%"/>
	                </td>
                </tr>
               	 <tr> 
                    ...
                    <td class="list_right_box">
                        <input name="jobNumberJt" id="jobNumberJt" class="mini-textbox" readonly="readonly" value="${information.jobNumberJt}"
                               width="100%"/>
                    </td>
                 </tr>
               	 <tr>
               	 	<td class="list_left_box1" valign="top">用工形式：</td>
                    <td class="list_right_box" width="30%">
                        <input id="workType" name="workType" class="mini-combobox" readonly="readonly" style="width:100%;" value="${information.workType}"  textField="dicname" valueField="dicvalue"
		                   		url="../system/dectionary!listjson.action?id=402881955da5b404015da5b98cad000a" showNullItem="true" emptyText="请选择..." nullItemText="请选择..." />
                    </td> 
                    ...
                    <td class="list_right_box">
                        <input name="name" id="name" class="mini-textbox" readonly="readonly" value="${information.name}"
                        width="100%"/>
                    </td>
                   ...
                   <td class="list_left_box1" valign="top">证件类型：</td>
                    <td class="list_right_box">
                        <input id="idType" name="idType" class="mini-combobox" style="width:100%;" value="${information.idType}"  textField="dicname" valueField="dicvalue"
		                   		readonly="readonly" url="../system/dectionary!listjson.action?id=402881935ba8c785015ba8d9d7c0000b" showNullItem="true" emptyText="请选择..." nullItemText="请选择..." />
                    </td>
                    <td class="list_left_box1" valign="top">证件号码：</td>
                    <td class="list_right_box">
                        <input name="idNumber" id="idNumber" readonly="readonly" class="mini-textbox" value="${information.idNumber}"
                                vtype="maxLength:20" width="100%"/>
                    </td>
                 </tr>
                    ...
                    <td class="list_right_box">
                        <input class="mini-datepicker" format="yyyy-MM-dd"
									name="borthDate" id="borthDate" style="width: 100%" msg="日期格式不正确" allowInput="false" 
									 readonly="readonly" value="${information.borthDate}"/>
                    </td> 
                    <td class="list_left_box1" valign="top">年龄：</td>
                    <td class="list_right_box">
                        <input id="age" name="age" class="mini-textbox" readonly="readonly" value="${age}" style="width: 85%;"/>&nbsp;&nbsp;&nbsp;岁
                    </td> 
                </tr>
                ...
                <tr>
                    ...
                    <td class="list_left_box1" valign="top">扣减工龄：</td>
                    <td class="list_right_box">
                        <input name="annualLeave" id="annualLeave" readonly="readonly"  class="mini-textbox" value="${information.annualLeave}"
                                vtype="maxLength:20" width="100%"/>
                    </td>
                 </tr>
                 <tr>
                    ...
                    <td class="list_right_box">
                        <input id="politicsStatus" readonly="readonly" name="politicsStatus" class="mini-combobox" style="width:100%;" value="${information.politicsStatus}"  textField="dicname" valueField="dicvalue"
                 ...
                 <tr>
                    ...
                    <td class="list_right_box">
                        <input id="highestTitle" name="highestTitle" class="mini-combobox" style="width:100%;" value="${information.highestTitle}"  textField="dicname" valueField="dicvalue"
		                   		readonly="readonly" url="../system/dectionary!listjson.action?id=402881955d176487015d17682e54000a" showNullItem="true" emptyText="请选择..." nullItemText="请选择..." />
                    </td>
                    ...
                    <td class="list_right_box">
                        <input id="proQuaLevel" name="proQuaLevel" class="mini-combobox" style="width:100%;" value="${information.proQuaLevel}"  textField="dicname" valueField="dicvalue"
		                   		readonly="readonly" url="../system/dectionary!listjson.action?id=402881955d176487015d17685ddb000b" showNullItem="true" emptyText="请选择..." nullItemText="请选择..." />
                    </td>   
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td class="list_right_box" width="30%">
                        <input id="empSource" name="empSource" class="mini-combobox" readonly="readonly"  style="width:100%;" value="${information.empSource}"  textField="dicname" valueField="dicvalue"
                    ...
                    <td class="list_right_box">
                        <input id="formerIdentity" name="formerIdentity" readonly="readonly" class="mini-combobox" style="width:100%;" value="${information.formerIdentity}"  textField="dicname" valueField="dicvalue"
                ...
                <tr>
                    ...
                    <td class="list_right_box" width="30%">
                        <input id="health" name="health" class="mini-combobox"  style="width:100%;" value="${information.health}"  textField="dicname" valueField="dicvalue"
		                   		url="../system/dectionary!listjson.action?id=402881935b8df599015b8e1443ac001c" showNullItem="true" emptyText="请选择..." nullItemText="请选择..." />
                    </td>   
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td class="list_right_box" colspan="3">
                        <input id="remark1" name="remark1" class="mini-textarea" value="${information.remark1}"  maxlength="50"style="width: 100%;height:50px"/>
                    </td>
                ...
                <tr>
                	...
                	<td class="list_right_box" colspan="3">
                        <input id="remark3" name="remark3" class="mini-textarea" value="${information.remark3}"  maxlength="50"style="width: 100%;height:50px"/>
                    </td> 
                </tr>
                <tr> 
               		<td align="left"   colspan="4" > &nbsp;</td> 
                ...
                <tr>
                    ...
                    <td class="list_right_box" colspan="3">
                        <input id="messageAddress" name="messageAddress" class="mini-textarea" value="${information.messageAddress}"  maxlength="50"style="width: 100%;height:50px"/>
                    </td> 
                ...
                <tr>
                    <td class="list_left_box1" valign="top">详细地址：</td>
                    <td class="list_right_box" colspan="3">
                        <input name="upAddress" id="upAddress" class="mini-textbox" value="${information.upAddress}"
                                width="100%"/>
                    </td>  
                </tr> 
        		<tr> 
                ...
                <tr>
                    ...
                    <td class="list_right_box">
                        <input class="mini-datepicker" format="yyyy-MM-dd"
									name="inCompanyTime" id="inCompanyTime" readonly="readonly" style="width: 100%" msg="日期格式不正确" allowInput="false"
									 value="${information.inCompanyTime}"/>
                    </td> 
                    <td class="list_left_box1" valign="top">入司时间2：</td>
                    <td class="list_right_box">
                        <input class="mini-datepicker" format="yyyy-MM-dd"
									name="inCompanyTime2" id="inCompanyTime2" readonly="readonly" style="width: 100%" msg="日期格式不正确" allowInput="false"
               ...
               <tr>
                ...
                <tr>
                    ...
                    <td class="list_right_box" width="30%">
                        <input id="onPost" name="onPost" class="mini-combobox" readonly="readonly" style="width:100%;" value="${information.onPost}"  textField="dicname" valueField="dicvalue"
                    ...
                    <td class="list_right_box" width="30%">
                        <input id="laborCompany" name="laborCompany" class="mini-combobox" readonly="readonly"  style="width:100%;" value="${information.laborCompany}"  textField="dicname" valueField="dicvalue"
                ...
                <tr>
                    ...
                    <td class="list_right_box">
                        <input id="departName" name="departName" class="mini-textarea" readonly="readonly" value="${information.departName}"  maxlength="32"style="width: 100%"/>
                    </td>
                    <td class="list_left_box1" valign="top">所属班组：</td>
                    <td class="list_right_box">
                        <input id="classNo" name="classNo" class="mini-textarea" readonly="readonly" value="${information.classNo}" readonly="readonly"  maxlength="32"style="width: 100%"/>
                    </td>
               </tr>
               <tr>
                	<td class="list_left_box1" valign="top">成本单位：</td>
                    <td class="list_right_box">
                        <input id="costOffice" name="costOffice" readonly="true" class="mini-textarea" value="${information.costOffice}"  maxlength="32"style="width: 100%"/>
                    </td> 
                    <td class="list_left_box1" valign="top">成本部门：</td>
                    <td class="list_right_box">
                        <input id="costDep" name="costDep" class="mini-textarea" readonly="true" value="${information.costDep}"  maxlength="32"style="width: 100%"/>
                    </td> 
                </tr>
                <tr>
                	<td class="list_left_box1" valign="top">所属模块：</td>
                    <td class="list_right_box">
                        <input id="module" name="module" class="mini-textarea" readonly="true" value="${information.module}"  maxlength="32"style="width: 100%"/>
                    </td> 
                </tr>
                <tr>
                	<td class="list_left_box1" valign="top">具体岗位：</td>
                    <td class="list_right_box" width="30%">
                        <input id="specificPostId" name="specificPostId" readonly="readonly" class="mini-buttonedit" onbuttonclick="onButtonEdit1" width="100%"
                ...
                <tr>
                    ...
                    <td class="list_right_box">
                        <input id="postType" name="postType" class="mini-combobox" readonly="readonly" style="width:100%;" value="${deptPosition.postType}"  textField="dicname" valueField="dicvalue"
		                   		url="../system/dectionary!listjson.action?id=402881825c152f73015c1573bffd000b" showNullItem="true" emptyText="请选择..." nullItemText="请选择..." />
               	    </td> 
                    <td class="list_left_box1" valign="top">岗位序列：</td>
                    <td class="list_right_box">
                        <input id="postOrder" name="postOrder" class="mini-combobox" readonly="readonly" style="width:100%;" value="${deptPosition.postOrder}"  textField="dicname" valueField="dicvalue"
                    ...
                    <td class="list_right_box">
                        <input class="mini-datepicker" format="yyyy-MM-dd"
									name="beginTime" id="beginTime" style="width: 100%" msg="日期格式不正确" allowInput="false"
									 readonly="readonly" value="${information.beginTime}"/>
                    </td>
                </tr> 
                 <tr>
                 	<td class="list_left_box1" valign="top">职务级别：</td>
                    <td class="list_right_box">
                        <input id="jobLevel" name="jobLevel" class="mini-combobox" readonly="readonly" style="width:100%;" value="${information.jobLevel}"  textField="dicname" valueField="dicvalue"
           ...
           <table cellpadding="0" cellspacing="0" border="0" class="addtable" width="90%" align="center">
            ...
            <div id="showTime1" style = "width:90%;margin-left:5%">
	            <div id="jzgrid" class="mini-datagrid" style="width:100%;" showPager="false"
        			 ...
        			 allowAlternating="true" pageSize="10" >
			                <div property="columns">
		                        ...
		                        <div field="film" width="100" headerAlign="center" align="left">兼职公司</div>
		                        <div field="dep" width="100" headerAlign="center" align="left">所属部门</div>
             ...
             <table cellpadding="0" cellspacing="0" border="0" class="addtable" width="90%" align="center">    
                ...
                <tr>
                    ...
                    <td class="list_right_box" width="30%">
                        <input id="degree" name="degree" class="mini-combobox" style="width:100%;" value="${education.degree}"  textField="dicname" valueField="dicvalue"
                ...
                <tr>
                    ...
                    <td class="list_right_box" width="30%">
                        <input id="educationLever2" name="educationLever2" class="mini-combobox" style="width:100%;" value="${education2.educationLever}"  textField="dicname" valueField="dicvalue"
		                   		readonly="true" url="../system/dectionary!listjson.action?id=402881a05b650042015b6617c989002f" showNullItem="true" emptyText="请选择..." nullItemText="请选择..." />
                    </td>
                    <%-- <td class="list_right_box">
                    ...
                    <td class="list_right_box" width="30%">
                        <input id="degree2" name="degree2" class="mini-combobox" style="width:100%;" value="${education2.degree}"  textField="dicname" valueField="dicvalue"
		                   		readonly="true"  url="../system/dectionary!listjson.action?id=402881a05b650042015b663e8700003f" showNullItem="true" emptyText="请选择..." nullItemText="请选择..." />
                    </td>  
                </tr>
                <tr>
            ...
            <div id="showTime1" style = "width:90%;margin-left:5%">
	            <div id="zyllgrid" class="mini-datagrid" style="width:100%;" showPager="false" 
			         ...
			         <div property="columns">
	                        ...
	                        <div field="rzpost" id ="rzpost" name = "rzpost"width="100" headerAlign="center" align="left">任职岗位</div>
	                        <div field="prove" id ="prove" name = "prove"width="100" headerAlign="center" align="left">证明人</div>
	                        <div type="comboboxcolumn" field="proDuty" width="100" headerAlign="center" align="center">证明人职务
	            ...
	            <div id="shgxgrid" class="mini-datagrid" style="width:100%;"  showPager="false"
        			 ...
        			 <div property="columns">
			        	 ...
			        	 <div field="borthDate" id ="borthDate" name = "borthDate"width="100" headerAlign="center" align="left">出生日期</div>
			       	     <div type="comboboxcolumn" field="relation" width="100" headerAlign="center" align="center">与本人关系
                   <input property="editor" class="mini-combobox" url="../system/dectionary!listjson.action?id=402881955cd2b9a3015cd2fd7cbc0002" textField="dicname" valueField="dicvalue"/>
               	 </div>
		         ...
		         <div type="comboboxcolumn" field="call" width="100" headerAlign="center" align="center">称谓
                   <input property="editor" class="mini-combobox" url="../system/dectionary!listjson.action?id=402881955cd2b9a3015cd2fda7060003" textField="dicname" valueField="dicvalue"/>
               	 </div>
			        	 <div type="comboboxcolumn" field="nation" width="100" headerAlign="center" align="center">民族
                   <input property="editor" class="mini-combobox" url="../system/dectionary!listjson.action?id=402881955cce6bd4015cce9be464000b" textField="dicname" valueField="dicvalue"/>
               	 </div>
            ...
            <table cellpadding="0" cellspacing="0" border="0" class="addtable" width="90%" align="center">       
                ...
                <tr>
                    ...
                    <td class="list_right_box">
                    <input class="mini-combobox" name="annuityType" id="annuityType" url="../system/dectionary!listjson.action?id=402881aa5db0fa65015db10c2ab4000f"
                            readonly="readonly" width="100%" value="${information.annuityType}"  textField="dicname" valueField="dicvalue"/>
                        
                    </td> 
                    <td class="list_left_box1" valign="top">年金缴费状态：</td>
                    <td class="list_right_box">
                                
                         <input name="annuityState" id="annuityState" readonly="readonly" class="mini-combobox" value="${information.annuityState}" data="[{id:0, text:'未停止缴费'},{id:1, text:'停止缴费'}]" width="100%"/>
                    </td> 
                ...
                <tr>
                    ...
                    <td class="list_right_box">
                        <input id="annuityCompany" name="annuityCompany" readonly="readonly" class="mini-textarea" value="${information.annuityCompany}"  maxlength="50"style="width: 100%"/>
                    </td> 
                    <td class="list_left_box1" valign="top">身份类别：</td>
                    <td class="list_right_box">
                    <input class="mini-combobox" name="sflb" id="sflb" data="[{id:1,text:'干部'},{id:2,text:'工人'}]"
                           readonly="readonly"  width="100%" value="${information.sflb}" />
            ...
            <div class="mini-toolbar" style="text-align:center;padding-top:8px;padding-bottom:8px;position: fixed;bottom: 0;width: 100%;" borderStyle="border:0;">
            	...
            	<a class="mini-button" id="upload" onclick="upload" style="width:100px;margin-right:20px;" iconCls="icon-upload">照片上传</a>
	            ...
	            <a class="mini-button" onclick="onCancel" id="onCancel" iconCls="icon-close" style="width:60px;" iconCls="icon-close">关闭</a> 
	            <a class="mini-button" onclick="lookxx" id="lookxx" iconCls="icon-search" style="width:100px;" iconCls="icon-close">查看详细</a> 
        	</div>
    ...
    <script type="text/javascript">
        ...
        if("1"==${flag}){
            ...
            mini.get("lookxx").setVisible(false);
        }else if("0"==${flag}){
        	mini.get("lookxx").setVisible(false);
        }else{
        	mini.get("upload").setVisible(false);
        ...
        function onOk(){
            ...
            $.ajax({
                url: "../personnel/personnel!saveOrUpdate.action",
                data:{
                	formdata:json,
                    child:"${child}"
                },
      ...
      //籍贯
        ...
        function lookxx() {
        	var personid=mini.get("id").getValue();
      		var tabs = window.parent.mini.get("mainTabs");
            var tab = { title: "员工管理查看", showCloseButton: true };
            tab.url = "../personnel/personnel!all.action?personId="+personid;
            tabs.addTab(tab);
            tabs.activeTab(tab);
            CloseWindow('add');
        }
