...
<body>
    <form id="form1" method="post">
        ...
        <input class="mini-hidden" name="content" id="content" value="${ckContent.content}" style="display:none;"/>
        <div>
            <table cellpadding="0" cellspacing="0" border="0" class="addtable" width="100%">
                <tr>
                    <td class="list_left_box1" valign="top" width="13%">内容 ： <s:property  value=""/></td> 
                    <td class="list_right_box" width="12%">  
                     <s:if test="ckContent.content!=''">${ckContent.content}</s:if><s:else>
                        <input id="cont" class="mini-combobox" textField="text" 
                        onvaluechanged="onDeptChanged"  valueField="id" emptyText=""  
                         value="" url="../check/content!loadcontent.action"/>
                     </s:else>
                    </td>
        ...
        <div class="mini-toolbar" style="text-align:center;padding-top:8px;padding-bottom:8px;position: fixed;bottom: 0;width: 100%;" borderStyle="border:0;">
            <a class="mini-button" id="ok" onclick="onOk(0)" iconCls="icon-save" style="width:60px;margin-right:20px;"iconCls="icon-save">保存</a>  
    ...
    <script type="text/javascript">
        ...
        function onDeptChanged(e){
            ...
            var id = mini.get("cont").getValue(); 
        	window.location.href="../check/content!modeladd.action?id="+id;
        }
        function onOk(id){
