...
<%--                 <tr>
                   <td class="list_left_box1" valign="top">劳保所属岗位：</td>
                    <td class="list_right_box">
                        <input name="lbpost" id="lbpost" class="mini-combobox" style="width:100%;" value="${information.lbpost}" textField="dicname" valueField="dicvalue"
		                   		url="../system/dectionary!listjson.action?id=402828e85f13a418015f13a4f1690008" showNullItem="true" emptyText="请选择..." nullItemText="请选择..." />
                    </td> 
           ...
           <div class="mini-toolbar" style="text-align:center;padding-top:8px;padding-bottom:8px;position: fixed;bottom: 0;width: 100%;" borderStyle="border:0;">
           	   <a class="mini-button" id="saom" onclick="saom" iconCls="icon-save" style="width:100px;margin-right:20px;"iconCls="icon-save">身份证扫描</a> 
