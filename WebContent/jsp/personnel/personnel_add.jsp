        ...
        <table cellpadding="0" cellspacing="0" border="0" class="addtable" width="90%" align="center">
                ...
                <tr>
                    ...
                    <td class="list_right_box" width="20%">
                        <input id="empType" name="empType" class="mini-combobox"  style="width:100%;" value="${information.empType}"  textField="dicname" valueField="dicvalue"
                ...
                <tr>
                    ...
                    <td class="list_right_box" width="30%">
                        <input id="onJob" name="onJob" class="mini-combobox"   style="width:100%;" value="${information.onJob}"  textField="dicname" valueField="dicvalue"
                ...
                <tr>
                    ...
                    <td class="list_right_box" width="30%">
                        <input id="workType" name="workType" class="mini-combobox" style="width:100%;" value="${information.workType}"  textField="dicname" valueField="dicvalue"
                ...
                <tr>
                    ...
                    <td class="list_right_box">
                        <input name="annualLeave" id="annualLeave"  class="mini-textbox" value="${information.annualLeave}"
                                vtype="maxLength:20" width="100%"/>
                    </td>
                 </tr>
                 <tr>
               ...
               <tr>
                ...
                <tr>
                    ...
                    <td class="list_right_box">
                        <input name="postId" id="postId" class="mini-buttonedit" value="${information.postId}" text="${information.post}"  width="100%"/>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td class="list_right_box">
                        <input id="postType" name="postType" class="mini-combobox" style="width:100%;" value="${deptPosition.postType}"  textField="dicname" valueField="dicvalue"
		                   		url="../system/dectionary!listjson.action?id=402881825c152f73015c1573bffd000b" showNullItem="true" emptyText="请选择..." nullItemText="请选择..." readonly="true"/>
               	    </td> 
            ...
            <div id="showTime1" style = "width:90%;margin-left:5%">
             ...
             <table cellpadding="0" cellspacing="0" border="0" class="addtable" width="90%" align="center">    
                ...
                <tr>
                    ...
                    <td class="list_right_box" width="30%">
                        <input id="educationLever" name="educationLever" class="mini-combobox" style="width:100%;" readonly="true" value="${education.educationLever}"  textField="dicname" valueField="dicvalue"
                    ...
                    <td class="list_right_box" width="30%">
                        <input id="degree" name="degree" class="mini-combobox" style="width:100%;" value="${education.degree}" readonly="true" textField="dicname" valueField="dicvalue"
                ...
                <tr>
                    ...
                    <td class="list_right_box" width="30%">
                        <input id="educationLever2" name="educationLever2" class="mini-combobox" style="width:100%;" value="${education2.educationLever}"  textField="dicname" valueField="dicvalue"
		                   		 url="../system/dectionary!listjson.action?id=402881a05b650042015b6617c989002f" showNullItem="true" emptyText="请选择..." nullItemText="请选择..." readonly="true" />
                    </td>
                    <%-- <td class="list_right_box">
                        <input class="mini-textbox" value="${education2.educationLever}"width="100%" />
                    </td> --%>
                    <td class="list_left_box1" valign="top">在职教育最高学位：</td>
                    <%-- <td class="list_right_box">
                        <input class="mini-textbox" value="${education2.degree}"width="100%" />
                    </td> --%>
                    <td class="list_right_box" width="30%">
                        <input id="degree2" name="degree2" class="mini-combobox" style="width:100%;" value="${education2.degree}"  textField="dicname" valueField="dicvalue" readonly="true"
		                   		  url="../system/dectionary!listjson.action?id=402881a05b650042015b663e8700003f" showNullItem="true" emptyText="请选择..." nullItemText="请选择..." />
                    </td>  
                </tr>
                <tr>
            ...
            <table cellpadding="0" cellspacing="0" border="0" class="addtable" width="90%" align="center">       
                ...
                <tr>
                    ...
                    <input class="mini-combobox" name="annuityType" id="annuityType" url="../system/dectionary!listjson.action?id=402881aa5db0fa65015db10c2ab4000f"
                            width="100%" value="${information.annuityType}"  textField="dicname" valueField="dicvalue"/>
                        
                    </td> 
                    <td class="list_left_box1" valign="top">年金缴费状态：</td>
                    <td class="list_right_box">
                                
                         <input name="annuityState" id="annuityState" class="mini-combobox" value="${information.annuityState}" data="[{id:0, text:'未停止缴费'},{id:1, text:'停止缴费'}]" width="100%"/>
                    </td> 
                ...
                <tr>
                    ...
                    <td class="list_right_box">
                        <input id="annuityCompany" name="annuityCompany" class="mini-textarea" value="${information.annuityCompany}"  maxlength="50"style="width: 100%"/>
                    </td> 
                    <td class="list_left_box1" valign="top">身份类别：</td>
                    <td class="list_right_box">
                    <input class="mini-combobox" name="sflb" id="sflb" data="[{id:1,text:'干部'},{id:2,text:'工人'}]"
                            width="100%" value="${information.sflb}" />
