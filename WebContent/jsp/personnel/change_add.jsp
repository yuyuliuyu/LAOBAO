...
<body>
    <form id="form1" method="post">
        ...
        <input class="mini-hidden" name="depshowId" id="depshowId" value="${depshowId}" style="display:none;"/>
        	...
        	<table id="table1" cellpadding="0" cellspacing="0" border="0" class="addtable" width="100%">
                ...
                <tr>
                	...
                	<td class="list_right_box">
                        <input class="mini-datepicker" format="yyyy-MM-dd hh:mm:ss" showTime="true"
                ...
                <tr>
                    ...
                    <td class="list_right_box" width="30%">
                        <input id="jobLevel2" name="jobLevel2" class="mini-combobox" style="width:90%;" value="${change.jobLevel2}"  textField="dicname" valueField="dicvalue"
		                   		required="true" url="../system/dectionary!listjson.action?id=402881935ba8c785015ba8e043c80011" showNullItem="true" emptyText="请选择..." nullItemText="请选择..." />
                    </td>
                </tr>
                <tr>
	...
	//选择岗位
 	function onButtonEdit1(e) {
        var btnEdit = this;
        if(mini.get("dep2").getValue()==null||mini.get("dep2").getValue()==""){
        	var depart=mini.get("depshowId").getValue();
        }else{
