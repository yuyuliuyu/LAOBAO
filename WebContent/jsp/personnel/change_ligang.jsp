...
<body>
        ...
        <input class="mini-hidden" name="personId" id="personId" value="${personId}" style="display:none;"/>
   	    <div id="table11">
        	<table id="table1" cellpadding="0" cellspacing="0" border="0" class="addtable" width="90%">
                ...
                <tr>
                	<tr>
	        			<td class="list_left_box1" valign="top">是否中止合同：</td>
	                    <td class="list_right_box">
	                        <input id="isEnd" name="isEnd" class="mini-combobox"
	                        	emptyText="请选择..." 
	...
	function onOk() {
		...
		var username=mini.get("pername").getValue();
		var isEnd=mini.get("isEnd").getValue();
		form.validate();
		...
		$.ajax({
			url : "../personnel/change!saveOrUpdateLigang.action?username="+username+"&isEnd="+isEnd,
			type : 'post',
			data : {
				formdata : json
			},
