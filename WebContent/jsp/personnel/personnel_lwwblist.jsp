...
<body>
		...
		<div class="mini-splitter" style="width:100%;height:100%;" handlerSize="9">
            ...
            <div showCollapseButton="false">
	            ...
	            <div class="mini-toolbar" style="padding:0px;border-top:0;">
	       			 <table style="width:100%;">
			                ...
			                <td style="width:100%;">
			                    ...
			                    <a class="mini-button" iconCls="icon-edit" onclick="personedit()">员工自我编辑</a>
			                    ...
			                    <a class="mini-button" iconCls="icon-tip" onclick="zhuanzheng()">转成正式工</a>
			                </td>
	            		 </tr>
	        		</table>
	    		</div>
	    		...
	    		<div id="grid" class="mini-datagrid" style="width:100%;height:100%;" 
             		url="../personnel/personnel!getLwwbPersonData.action" idField="id" multiSelect="true" 
            		 allowAlternating="true" pageSize="100" >
		                ...
		                <div property="columns">
	                        ...
	                        <div type="comboboxcolumn" field="jobLevel" id ="jobLevel" name = "jobLevel" width="100" headerAlign="center" align="center" >职务级别
	                        ...
	                        <div type="comboboxcolumn" field="empType" width="100" headerAlign="center" align="center">员工类型
                            	<input property="editor" class="mini-combobox" data="[{id:0, text:'普通员工'},{id:1, text:'劳务外包人员'},{id:2, text:'业务外包人员'}]"/>
                        	</div>
                        	<div type="comboboxcolumn" field="onJob" width="100" headerAlign="center" align="center">员工状态
                            	<input property="editor" class="mini-combobox" data="[{id:1, text:'试岗期'},{id:2, text:'正式工'},{id:3, text:'离职'},{id:4, text:'退休'},{id:5, text:'返聘'}]"/>
                        	</div>
    ...
    <script type="text/javascript">
        ...
        function personedit() {
            ...
            if (row) {
            	mini.open({
                    url : "../personnel/personnel!personedit.action?flag=0&personId="+row.id,
                    title : "编辑人员信息",
                    width : 900,
                    height : 600,
        ...
        function zhuanzheng() {
            ...
            if (row) {
                mini.open({
                    url : "../personnel/personnel!zhuanzheng.action?id=" + row.id+"&flag=1",
                    title : "转正页面",
                    width : 770,
                    height : 540,
                    /* allowResize : false, */
