...
<body>
		...
		<div class="mini-splitter" style="width:100%;height:100%;" handlerSize="9">
            ...
            <div showCollapseButton="false">
	    		...
	    		<div id="grid" class="mini-datagrid" style="width:100%;height:100%;" 
             		 url="../personnel/personnel!getYwwbPersonData.action" idField="id" multiSelect="true" 
    ...
    <script type="text/javascript">
        ...
        function edit() {
            ...
            if (row) {
            	mini.open({
                    url : "../personnel/personnel!edit.action?personId="+row.id+"&jobNumber="+row.jobNumber,
                    title : "编辑人员信息",
                    width : 900,
                    height : 600,
