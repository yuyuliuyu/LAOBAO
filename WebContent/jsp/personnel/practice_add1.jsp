        ...
        <table cellpadding="0" cellspacing="0" border="0" class="addtable" width="90%" align="center">
                ...
                <tr>
                   <td class="list_left_box1" valign="top">证件类型：</td>
                    <td class="list_right_box">
                        <input id="idType" name="idType" readonly="readonly" class="mini-combobox" style="width:100%;" value="${information.idType}"  textField="dicname" valueField="dicvalue"
                ...
                <tr>
                    ...
                    <td class="list_right_box" width="30%">
                        <input id="empSource" name="empSource" class="mini-combobox" style="width:100%;" value="${information.empSource}"  textField="dicname" valueField="dicvalue"
		                   		readonly="readonly"  url="../system/dectionary!listjson.action?id=402881935baceaa1015badf989e30015" showNullItem="true" emptyText="请选择..." nullItemText="请选择..." />
                    </td> 
                    ...
                    <td class="list_right_box">
                        <input class="mini-datepicker" format="yyyy-MM-dd"
									name="inCompanyTime" id="inCompanyTime" style="width: 100%" msg="日期格式不正确" allowInput="false"
									 readonly="readonly"  value="${information.inCompanyTime}"/>
                    </td> 
                    ...
                    <td class="list_right_box">
                        <input class="mini-datepicker" format="yyyy-MM-dd"
									name="inCompanyTime2" id="inCompanyTime2" style="width: 100%" msg="日期格式不正确" allowInput="false"
									 readonly="readonly"  value="${information.inCompanyTime2}"/>
                    </td> 
               </tr>
               <tr>
                ...
                <tr>
                    ...
                    <td class="list_right_box" width="30%">
                        <input id="onPost" name="onPost" class="mini-combobox" style="width:100%;" value="${information.onPost}"  textField="dicname" valueField="dicvalue"
		                   		readonly="readonly"  url="../system/dectionary!listjson.action?id=402881955bc84595015bc87aa73e0010" showNullItem="true" emptyText="请选择..." nullItemText="请选择..." />
                    </td> 
                    ...
                    <td class="list_right_box" width="30%">
                        <input id="laborCompany" name="laborCompany" class="mini-combobox"  style="width:100%;" value="${information.laborCompany}"  textField="dicname" valueField="dicvalue"
		                   		readonly="readonly"  url="../system/dectionary!listjson.action?id=402881955d1ba95e015d1bbcbed5000a" showNullItem="true" emptyText="请选择..." nullItemText="请选择..." />
                    </td> 
                </tr>
                <tr>
                    ...
                    <td class="list_right_box">
                        <input id="classNo" name="classNo" class="mini-textarea" value="${information.classNo}" readonly="readonly"  maxlength="32"style="width: 100%"/>
                    </td>
               </tr>
               <tr>
                	<td class="list_left_box1" valign="top">成本单位：</td>
                    <td class="list_right_box">
                        <input id="costOffice" name="costOffice" class="mini-textarea" value="${information.costOffice}" readonly="readonly"   maxlength="32"style="width: 100%"/>
                    </td> 
                    <td class="list_left_box1" valign="top">成本部门：</td>
                    <td class="list_right_box">
                        <input id="costDep" name="costDep" class="mini-textarea" value="${information.costDep}" readonly="readonly"   maxlength="32"style="width: 100%"/>
                    </td> 
                </tr>
                <tr>
                	<td class="list_left_box1" valign="top">所属模块：</td>
                    <td class="list_right_box">
                        <input id="module" name="module" class="mini-textarea" value="${information.module}" readonly="readonly"   maxlength="32"style="width: 100%"/>
                    </td> 
                </tr>
                <tr>
                    ...
                    <td class="list_right_box" width="30%">
                        <input id="specificPostId" name="specificPostId" class="mini-buttonedit" onbuttonclick="onButtonEdit1" width="100%"
                                readonly="readonly"  value="${information.specificPostId}" text="${information.specificPost}" allowInput="false"/> 
                    </td>
                    <td class="list_left_box1" valign="top">标准岗位：</td>
                    <td class="list_right_box">
                        <input name="postId" id="postId" class="mini-buttonedit" readonly="readonly"  value="${information.postId}" text="${information.post}" readonly="true" width="100%"/>
                    </td>
                ...
                <tr>
                    ...
                    <td class="list_right_box">
                        <input id="postType" name="postType" class="mini-combobox" style="width:100%;" value="${deptPosition.postType}"  textField="dicname" valueField="dicvalue"
		                   		readonly="readonly"  url="../system/dectionary!listjson.action?id=8aa385705d0b61c0015d0cdf761200ea" showNullItem="true" emptyText="请选择..." nullItemText="请选择..." />
               	    </td> 
                    ...
                    <td class="list_right_box">
                        <input id="postOrder" name="postOrder" class="mini-combobox" style="width:100%;" value="${deptPosition.postOrder}"  textField="dicname" valueField="dicvalue"
		                   		readonly="readonly"  url="../system/dectionary!listjson.action?id=8aa385705d0b61c0015d0cdfa20200eb" showNullItem="true" emptyText="请选择..." nullItemText="请选择..." />
               		 </td>
                </tr>
                <tr>
