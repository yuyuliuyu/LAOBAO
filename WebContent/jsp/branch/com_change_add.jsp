	...
	<div class="mini-fit" >
        ...
        <input class="mini-hidden" name="attachment" id="attachment" value="${orgHisMiddle.attachment}" style="display:none;"/>
            ...
            <tr>
                ...
                <td class="list_right_box" width="35%">
                	<input name="pid" id="pid" class="mini-buttonedit" value="${comChange.pid}"
                         text="${parentName}"   vtype="maxLength:50;required" width="200px" emptyText="请选择..."  onbuttonclick="onApplyCompEdit" />
            ...
            <tr>
                ...
                <td class="list_left_box1" valign="top">成立日期：</td>
                <td class="list_right_box" >
                    <input name="foundDate" id="foundDate" class="mini-datepicker" value="${comChange.foundDate}"
