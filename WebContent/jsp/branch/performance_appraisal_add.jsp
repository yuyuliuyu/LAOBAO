...
<body>
        ...
        <table style="width:100%;" cellpadding="0" cellspacing="0" border="0">
            <tr>
                ...
                <td class="list_right_box">
                   ...
                   <input name="jobNumber" id="jobNumber" class="mini-hidden" value="${performanceAppraisal.jobNumber}"/>
                </td>
    ...
    <script type="text/javascript">
        ...
        function onUserRowClick(e) {
        	...
        	mini.get("jobNumber").setValue(record.jobNumber)
        }

        function onOK() {
        	var perforRewardScroe = mini.get("perforRewardScroe");
        	var perforRewardMoney = mini.get("perforRewardMoney");
        	var perforPunishScroe = mini.get("perforPunishScroe");
        	var perforPunishMoney = mini.get("perforPunishMoney");
        	if (perforRewardScroe.getValue() == "" && perforRewardMoney.getValue() == "" && perforPunishScroe.getValue() == "" && perforPunishMoney.getValue() == "") {
        		mini.alert("考核奖励和考核扣罚至少要有一个值不能为空");
        		return;
        	}
        	onOk('branch', 'performance_appraisal','', false);
        }
    </script>
</body>
</html>
