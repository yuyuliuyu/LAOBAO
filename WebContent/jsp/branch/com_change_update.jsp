...
<body>
         ...
         <input class="mini-hidden" name="path" id="path" value="${path}" style="display:none;"/>
            ...
            <tr>
                ...
                <tr>
                    ...
                    <td class="list_right_box" width="35%">
                    	<input name="fzx" id="fzx" class="mini-textbox" value="${comChange.fzx}" 
                                    requiredErrorText="不能为空" vtype="maxLength:50" width="200px" onblur="onblur('fzx','srm')"/>
                        
                    </td>
                    <td class="list_left_box1" valign="top">输入码：</td>
                    <td class="list_right_box" >
                        <input name="srm" id="srm" class="mini-textarea" value="${comChange.srm}"
                               enabled="false" vtype="maxLength:100" width="200px" emptyText="系统自动生成"/>
                    </td>
                ...
                <tr>
                    ...
                    <td class="list_right_box" width="35%">
                    	<input name="jm" id="jm" class="mini-textarea" value="${comChange.jm}"
                    ...
                    <td class="list_right_box" >
                                ...
                                <input name="webUrl" id="webUrl" class="mini-textbox" value="${comChange.webUrl}" 
                ...
                <tr>
                    ...
                    <td class="list_right_box" width="35%">
                    	<input id="btnEdit1" name="pid" class="mini-buttonedit" onbuttonclick="onButtonEdit" width="200px"
                                value="${comChange.pid}" text="${pname}" allowInput="false"  />   
                        
                    </td>                    
                    <td class="list_left_box1" valign="top" width="15%">公司性质</td>
                    <td class="list_right_box" width="35%">
                        <input class="mini-combobox" name="type" data="companyxz" style="width: 200px" value="${comChange.type}"/>
                    </td>
                </tr>
                <tr>
                    <td class="list_left_box1" valign="top">公司荣誉：</td>
                    <td class="list_right_box" colspan="3">
                    	<input name="honor" id="honor" class="mini-textarea" value="${comChange.honor}"
				 ...
				 <tr>
                    ...
                    <td class="list_right_box" colspan="3">
                    	<input name="shortRemark" id="shortRemark" class="mini-textarea" value="${comChange.shortRemark}"
                ...
                <tr>
                    ...
                    <td class="list_right_box" colspan="3">
						...
						<input name="remark" id="remark" class="mini-textarea" value="${comChange.remark}"
                               vtype="maxLength:400" width="700px"/>
						        ...
						        <div id="editForm1" style="padding:5px;">
						            ...
						            <table  class="addtable" style="width:100%;" cellpadding="0" cellspacing="0" border="0">
						                <tr>
						                    ...
						                    <td class="list_right_box" >
						                      <input id="cmName" name="cmName" class="mini-textbox" value="${comChange.cmName}" maxlength="100"style="width: 90%;"/>
						                    </td>
						                    <td class="list_left_box1" valign="top" width="15%">类型：</td>
						                    <td class="list_right_box" >
						                      <input id="cmType" name="cmType" class="mini-combobox" value="${comChange.cmType}" data="companyType"style="width: 90%;"/>
						                    </td>
						                    <td class="list_left_box1" valign="top" width="15%">法定代表人：</td>
						                    <td class="list_right_box" >
						                      <input id="cmLegal" name="cmLegal" class="mini-textbox" value="${comChange.cmLegal}" maxlength="50"style="width: 90%;"/>
						                    </td>
						                </tr>
						                <tr>
						                    <td class="list_left_box1" valign="top" width="15%">住所：</td>
						                    <td class="list_right_box" >
						                    <input id="cmAddr" name="cmAddr" class="mini-textbox" value="${comChange.cmAddr}" maxlength="1000"style="width: 90%;"/>
						                    </td>
						                    <td class="list_left_box1" valign="top" width="15%">注册资本：</td>
						                    <td class="list_right_box" >
						                      <input id="cmZb" name="cmZb" class="mini-textbox"  value="${comChange.cmZb}" maxValue="999999"style="width: 90%;"/>
						                    </td>
						                    <td class="list_left_box1" valign="top" width="15%">成立日期：</td>
						                    <td class="list_right_box" >
                                                <input id="cmEstablishDate" name="cmEstablishDate" class="mini-datepicker" value="${comChange.cmEstablishDate}" style="width: 90%;"/>
                                            </td>
						                </tr>
						                <tr>
						                    <td class="list_left_box1" valign="top" width="15%">营业期限(上限)：</td>
						                    <td class="list_right_box" >
						                      <input id="cmYyqxHigh" name="cmYyqxHigh" class="mini-datepicker" value="${comChange.cmYyqxHigh}" forstyle="width: 90%;"mat="yyyy年MM月dd日"/>
						                    </td>
						                    <td class="list_left_box1" valign="top" width="15%">营业期限(下限)：</td>
						                    <td class="list_right_box" >
						                      <input id="cmYyqxLow" name="cmYyqxLow" class="mini-datepicker" value="${comChange.cmYyqxLow}" style="width: 90%;"/>
						                    </td>
						                </tr>
						                <tr>
						                    <td  class="list_left_box1" valign="top" width="15%">统一社会信用代码：</td>
                                            <td class="list_right_box" >
                                              <input name="cmTyshdm" class="mini-textbox" value="${comChange.cmTyshdm}"  maxlength="50"style="width: 90%;"/>
                                            </td>
						                    <td class="list_left_box1" valign="top" width="15%">开户行：</td>
						                    <td class="list_right_box" >
						                      <input id="cmBank" name="cmBank" class="mini-textbox" value="${comChange.cmBank}"  maxlength="50"style="width: 90%;"/>
						                    </td>
						                    <td  class="list_left_box1" valign="top" width="15%">账号：</td>
						                    <td class="list_right_box" >
						                      <input id="cmZh" name="cmZh" class="mini-textbox" value="${comChange.cmZh}" vtype="int" maxlength="50"style="width: 90%;"/>
						                    </td>
						                </tr>
						                <tr>
						                    <td class="list_left_box1" valign="top" width="15%">联系部门：</td>
						                    <td class="list_right_box" >
						                    <input id="cmLxbm" name="cmLxbm" class="mini-textbox" value="${comChange.cmLxbm}"  maxlength="50"style="width: 90%;"/>
						                    </td>
						                    <td  class="list_left_box1" valign="top" width="15%">联系人：</td>
						                    <td class="list_right_box" >
						                    <input id="cmLxr" name="cmLxr" class="mini-textbox" value="${comChange.cmLxr}" maxlength="50" style="width: 90%;"/>
						                    </td>
						                    <td  class="list_left_box1" valign="top" width="15%">职务：</td>
						                    <td class="list_right_box" >
						                    <input name="cmZw" class="mini-textbox" value="${comChange.cmZw}"  maxlength="50"style="width: 90%;"/>
						                    </td>
						                </tr>
						                <tr>
						                    <td class="list_left_box1" valign="top" width="15%">联系电话：</td>
						                    <td class="list_right_box" >
						                      <input id="cmPhone" name="cmPhone" class="mini-textbox" value="${comChange.cmPhone}"  maxlength="50"style="width: 90%;"/>
						                    </td>
						                    <td  class="list_left_box1" valign="top" width="15%">传真：</td>
						                    <td class="list_right_box" >
						                      <input id="cmFax" name="cmFax" class="mini-textbox" value="${comChange.cmFax}"  maxlength="50"style="width: 90%;"/>
						                    </td>
						                </tr>
						                <tr>
						                    <td  class="list_left_box1" valign="top" width="15%">经营范围：</td>
                                            <td class="list_right_box" width="10%" colspan="5">
                                              <input id="cmJyfw" name="cmJyfw" class="mini-textarea" value="${comChange.cmJyfw}"  maxlength="1000"style="width: 90%;height:50px"/>
                                            </td>
						                </tr>
						                <tr>
						                    <td  class="list_left_box1" valign="top" width="15%">通信地址：</td>
						                    <td class="list_right_box" width="10%" colspan="5">
                                              <input name="cmTxdz" class="mini-textarea" value="${comChange.cmTxdz}"  maxlength="1000" style="width: 90%;height:50px"/>
                                            </td>
						                </tr>
						                <tr>
                                            <td  class="list_left_box1" valign="top" width="15%">网页：</td>
						                    <td class="list_right_box" width="10%"colspan="5">
                                              <input name="cmWeb" class="mini-textarea" value="${comChange.cmWeb}"  maxlength="1000"style="width: 90%;height:50px"/>
                                            </td>
						                </tr>
						            </table>
						        </div>
	                ...
	                <td class="list_right_box" colspan="3">
	               		<div id="uploader-demo" class="wu-example">
						    ...
						    <div id="fileList" class="uploader-list">
						     <s:if test="comChange.imgpath!=null&&comChange.imgpath!=''">
						     		<div id="upImgName"  class="file-item thumbnail;upload-state-done" style="border:1px solid #ccc;"> 
					                    <img name="upImgName"  src="${sessionScope.path}${comChange.imgpath}" style="width:150px;height:100px;"/> 
					                    <div class="info"></div> 
				                	</div>
						     </s:if>
    ...
    <script type="text/javascript">
        ...
        function onOk(){
            ...
            $.ajax({
                url: "../branch/com_change!saveOrUpdate.action",
                data:{
                	formdata:json,
                	img : arr.join(","),
                    child:"${child}"
