...
<body>
	<form id="form1" method="post">
		<div>
			<input class="mini-hidden" name="id" id="id" value="${sysinfo.id}" style="display:none;" />  
			<input class="mini-hidden" name="state" id="state" value="${sysinfo.state}" style="display:none;" />  
			<table cellpadding="0" cellspacing="0" border="0" class="addtable" width="90%" align="center">
				<tr>
					<td align="left" colspan="4">&nbsp;</td>
				</tr>
				<tr>
					<td align="left" class="list_left_box1" height="20px" width="150px"><b>系统公告：</b></td>
				...
				<tr>
					...
					<td class="list_right_box"><input name="title" id="title"
						class="mini-textbox" value="${sysinfo.title}" width="100%" />
					</td>
					<td class="list_left_box1" valign="top" width="100px">发布时间：</td>
					<td class="list_right_box">
					<input name="fabutime" id="fabutime" class="mini-datepicker" value="${sysinfo.fabutime}" width="100%" /></td>
				</tr>
				<tr>
					<td class="list_left_box1" valign="top">内容：</td>
					<td class="list_right_box" colspan="3">
					 <textarea name="content" id="content" class="mini-textarea" width="100%" height="50px" emptyText="请输入公告内容">${sysinfo.content}</textarea>  
					</td>
				</tr>
			</table>
		</div>
...
<script type="text/javascript">
	...
	function onOk() {
		...
		$.ajax({
			url : "../system/system_info!saveOrUpdate.action",
			type : 'post',
			data : {
				jsondata : json
			},
