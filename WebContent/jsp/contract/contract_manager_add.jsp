...
<body>
	<form id="form1" method="post">
		<div>
			...
			<table cellpadding="0" cellspacing="0" border="0" class="addtable" width="90%" align="center">
				...
				<tr>
					...
					<input id="contracttermtype" name="contracttermtype" class="mini-combobox"  textField="text" valueField="id" emptyText="请选择.." 
					  onvaluechanged="onChanged" value="${contract.contracttermtype}" data="contracttermtype" required="true" style="width:96%;" allowInput="false"/>  
					</td>
				</tr>
				<tr>
			...
			<table cellpadding="0" cellspacing="0" border="0" class="addtable" width="90%" align="center">
				<tr>
					<td class="list_left_box1" valign="top" width="100px">合同结束日期：</td>
					<td class="list_right_box" width="165px">
						<input name="contractend" id="contractend" class="mini-datepicker" value="${contract.contractend}" width="100%" /> 
					</td>
					<td class="list_left_box1" valign="top" width="100px"></td>
					<td class="list_right_box">
			...
			<table cellpadding="0" cellspacing="0" border="0" class="addtable" width="90%" align="center"> 
				<tr>
					<td class="list_left_box1" valign="top" width="100px">工作地址：</td>
					<td class="list_right_box"><input name="workaddr" id="workaddr"
						class="mini-textbox" value="${contract.workaddr}" width="100%" />
					</td>
					<td class="list_left_box1" valign="top" width="100px">工作制：</td>
								...
								<table style="width:100%;">
									<tr>
										<td style="width:100%;">
											...
											<a class="mini-button" iconCls="icon-search" onclick="look()">查看附件</a> 
									</tr>
								</table>
							</div>
...
var contracttermtype = [{id: '0',text: '固定期限'}, 
    ...
    function onChanged(){
    	...
    	var isChange = mini.get("contracttermtype").getValue();
    	if(isChange==0){
	...
	function look() {
		...
		if (rows.length == 1) {  
			window.open(rows[0].realimageurl);
		} else {
			mini.alert("请选中一条记录！");
		}
	} 
