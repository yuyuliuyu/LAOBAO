...
<body>
    <form id="form1" method="post">
        ...
        <table cellpadding="0" cellspacing="0" border="0" class="addtable" width="100%">
                ...
                <tr>
                    <td class="list_left_box1" valign="top" width="15%">变更日期：</td>
                    <td class="list_right_box" width="30%">
                        <input name="xh" id="xh" class="mini-textbox" value="${cd.xh}"
                                vtype="maxLength:20;required" width="200px"/>
                    </td> 
                    <td class="list_left_box1" valign="top" width="15%">变更生效日期：</td>
                    <td class="list_right_box" width="30%">
                        <input name="xh" id="xh" class="mini-textbox" value="${cd.xh}"
                                vtype="maxLength:50" width="200px"/>
                    </td> 
                ...
                <tr>
                    <td class="list_left_box1" valign="top" width="15%">提出合同变更主体：</td>
                    <td class="list_right_box" width="30%">
                        <input name="xh" id="xh" class="mini-textbox" value="${cd.xh}"
                                vtype="maxLength:20;required" width="200px"/>
                    </td> 
                    <td class="list_left_box1" valign="top" width="15%">经办人：</td>
                    <td class="list_right_box" width="30%">
                        <input name="xh" id="xh" class="mini-textbox" value="${cd.xh}"
                                vtype="maxLength:50" width="200px"/>
                    </td> 
                ...
                <tr>
                    <td class="list_left_box1" valign="top" width="15%">原合同内容：</td>
                    <td class="list_right_box" width="30%">
                        <input name="xh" id="xh" class="mini-textbox" value="${cd.xh}"
                                vtype="maxLength:20;required" width="100%"/>
                    </td> 
                ...
                <tr>
                    <td class="list_left_box1" valign="top" width="15%">变更内容：</td>
                    <td class="list_right_box" width="30%">
                        <input name="xh" id="xh" class="mini-textbox" value="${cd.xh}"
                                vtype="maxLength:20;required" width="100%"/>
                    </td> 
