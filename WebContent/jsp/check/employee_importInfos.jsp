...
<body>
    <div class="mini-fit" id="form1" style="height: 10%;border-bottom:0;padding:0px;">
        <form id="uploaders" method="post" action="../check/employee!importSave.action"
            ...
            <table style="width:100%;height:100%">
                <tr>
                    ...
                    <td class="list_right_box">
                        <a href="../check/employee!download.action" style="color:blue; text-decoration: underline;">人员考勤基本信息模板.xls</a>	
                    </td>
                </tr>
                <tr>
