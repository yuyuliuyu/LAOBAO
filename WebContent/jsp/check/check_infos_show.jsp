...
<body style="line-height: 16px;">
            ...
            <table cellpadding="0" cellspacing="0" border="0" align="center" class="addtable" width="1650" style="margin:auto;padding-left:5px;padding-right:5px;">
                <tr>
                 ...
                 <tr>
                    ...
                    <td class="list_right_box">
                    	<input name="day1" id="day1" width="50px" value="${ckCheckInfo.day1}" 
							class="mini-combobox" textField="text" valueField="text" emptyText="请选择..." required="true" required="true" 
                    ...
                    <td class="list_right_box">
                        <input name="day2" id="day2" 
							...
							width="50px" value="${ckCheckInfo.day2}" url="../check/content!getContentList.action"/>
                    </td>
                    <td class="list_right_box">
                        <input name="day3" id="day3" 
							class="mini-combobox" textField="text" valueField="text" emptyText="请选择..." required="true"   
							width="50px" value="${ckCheckInfo.day3}" url="../check/content!getContentList.action"/>
                    </td>
                    <td class="list_right_box">
                        <input name="day4" id="day4" 
							class="mini-combobox" textField="text" valueField="text" emptyText="请选择..." required="true"   
							width="50px" value="${ckCheckInfo.day4}" url="../check/content!getContentList.action"/>
                    </td>
                    <td class="list_right_box">
                        <input name="day5" id="day5" 
							class="mini-combobox" textField="text" valueField="text" emptyText="请选择..." required="true"   
							width="50px" value="${ckCheckInfo.day5}" url="../check/content!getContentList.action"/>
                    </td>
                    <td class="list_right_box">
                        <input name="day6" id="day6" 
							class="mini-combobox" textField="text" valueField="text" emptyText="请选择..." required="true"   
							width="50px" value="${ckCheckInfo.day6}" url="../check/content!getContentList.action"/>
                    </td>
                    <td class="list_right_box">
                        <input name="day7" id="day7" 
							class="mini-combobox" textField="text" valueField="text" emptyText="请选择..." required="true"   
							width="50px" value="${ckCheckInfo.day7}" url="../check/content!getContentList.action"/>
                    </td>
                    <td class="list_right_box">
                        <input name="day8" id="day8" 
							class="mini-combobox" textField="text" valueField="text" emptyText="请选择..." required="true"   
							width="50px" value="${ckCheckInfo.day8}" url="../check/content!getContentList.action"/>
                    </td>
                    <td class="list_right_box">
                        <input name="day9" id="day9" 
							class="mini-combobox" textField="text" valueField="text" emptyText="请选择..." required="true"   
							width="50px" value="${ckCheckInfo.day9}" url="../check/content!getContentList.action"/>
                    </td>
                    <td class="list_right_box">
                        <input name="day10" id="day10" 
							class="mini-combobox" textField="text" valueField="text" emptyText="请选择..." required="true"   
							width="50px" value="${ckCheckInfo.day10}" url="../check/content!getContentList.action"/>
                    </td>
                    <td class="list_right_box">
                        <input name="day11" id="day11" 
							class="mini-combobox" textField="text" valueField="text" emptyText="请选择..." required="true"   
							width="50px" value="${ckCheckInfo.day11}" url="../check/content!getContentList.action"/>
                    </td>
                    <td class="list_right_box">
                        <input name="day12" id="day12" 
							class="mini-combobox" textField="text" valueField="text" emptyText="请选择..." required="true"   
							width="50px" value="${ckCheckInfo.day12}" url="../check/content!getContentList.action"/>
                    </td>
                    <td class="list_right_box">
                        <input name="day13" id="day13" 
							class="mini-combobox" textField="text" valueField="text" emptyText="请选择..." required="true"   
							width="50px" value="${ckCheckInfo.day13}" url="../check/content!getContentList.action"/>
                    </td>
                    <td class="list_right_box">
                        <input name="day14" id="day14" 
							class="mini-combobox" textField="text" valueField="text" emptyText="请选择..." required="true"   
							width="50px" value="${ckCheckInfo.day14}" url="../check/content!getContentList.action"/>
                    </td>
                    <td class="list_right_box">
                        <input name="day15" id="day15" 
							class="mini-combobox" textField="text" valueField="text" emptyText="请选择..." required="true"   
							width="50px" value="${ckCheckInfo.day15}" url="../check/content!getContentList.action"/>
                    </td>
                    <td class="list_right_box">
                        <input name="day16" id="day16" 
							class="mini-combobox" textField="text" valueField="text" emptyText="请选择..." required="true"   
							width="50px" value="${ckCheckInfo.day16}" url="../check/content!getContentList.action"/>
                    </td>
                    <td class="list_right_box">
                        <input name="day17" id="day17" 
							class="mini-combobox" textField="text" valueField="text" emptyText="请选择..." required="true"   
							width="50px" value="${ckCheckInfo.day17}" url="../check/content!getContentList.action"/>
                    </td>
                    <td class="list_right_box">
                        <input name="day18" id="day18" 
							class="mini-combobox" textField="text" valueField="text" emptyText="请选择..." required="true"   
							width="50px" value="${ckCheckInfo.day18}" url="../check/content!getContentList.action"/>
                    </td>
                    <td class="list_right_box">
                        <input name="day19" id="day19" 
							class="mini-combobox" textField="text" valueField="text" emptyText="请选择..." required="true"   
							width="50px" value="${ckCheckInfo.day19}" url="../check/content!getContentList.action"/>
                    </td>
                    <td class="list_right_box">
                        <input name="day20" id="day20" 
							class="mini-combobox" textField="text" valueField="text" emptyText="请选择..." required="true"   
							width="50px" value="${ckCheckInfo.day20}" url="../check/content!getContentList.action"/>
                    </td>
                    <td class="list_right_box">
                        <input name="day21" id="day21" 
							class="mini-combobox" textField="text" valueField="text" emptyText="请选择..." required="true"   
							width="50px" value="${ckCheckInfo.day21}" url="../check/content!getContentList.action"/>
                    </td>
                    <td class="list_right_box">
                        <input name="day22" id="day22" 
							class="mini-combobox" textField="text" valueField="text" emptyText="请选择..." required="true"   
							width="50px" value="${ckCheckInfo.day22}" url="../check/content!getContentList.action"/>
                    </td>
                    <td class="list_right_box">
                        <input name="day23" id="day23" 
							class="mini-combobox" textField="text" valueField="text" emptyText="请选择..." required="true"   
							width="50px" value="${ckCheckInfo.day23}" url="../check/content!getContentList.action"/>
                    </td>
                    <td class="list_right_box">
                        <input name="day24" id="day24" 
							class="mini-combobox" textField="text" valueField="text" emptyText="请选择..." required="true"   
							width="50px" value="${ckCheckInfo.day24}" url="../check/content!getContentList.action"/>
                    </td>
                    <td class="list_right_box">
                        <input name="day25" id="day25" 
							class="mini-combobox" textField="text" valueField="text" emptyText="请选择..." required="true"   
							width="50px" value="${ckCheckInfo.day25}" url="../check/content!getContentList.action"/>
                    </td>
                    <td class="list_right_box">
                        <input name="day26" id="day26" 
							class="mini-combobox" textField="text" valueField="text" emptyText="请选择..." required="true"   
							width="50px" value="${ckCheckInfo.day26}" url="../check/content!getContentList.action"/>
                    </td>
                    <td class="list_right_box">
                        <input name="day27" id="day27" 
							class="mini-combobox" textField="text" valueField="text" emptyText="请选择..." required="true"   
							width="50px" value="${ckCheckInfo.day27}" url="../check/content!getContentList.action"/>
                    </td>
                    <td class="list_right_box">
                        <input name="day28" id="day28" 
							class="mini-combobox" textField="text" valueField="text" emptyText="请选择..." required="true"   
							width="50px" value="${ckCheckInfo.day28}" url="../check/content!getContentList.action"/>
                    </td>
                    <td id="tr2td29" class="list_right_box">
                        <input name="day29" id="daye29" 
							class="mini-combobox" textField="text" valueField="text" emptyText="请选择..." required="false"   
							width="50px" value="${ckCheckInfo.day29}" url="../check/content!getContentList.action"/>
                    </td>
                    <td id="tr2td30" class="list_right_box">
                        <input name="day30" id="day30" 
							class="mini-combobox" textField="text" valueField="text" emptyText="请选择..." required="false"   
							width="50px" value="${ckCheckInfo.day30}" url="../check/content!getContentList.action"/>
                    </td>
                    <td id="tr2td31" class="list_right_box">
                        <input name="day31" id="day31" 
							class="mini-combobox" textField="text" valueField="text" emptyText="请选择..." required="false"   
							width="50px" value="${ckCheckInfo.day31}" url="../check/content!getContentList.action"/>
                    </td>
                </tr>
                <tr>
                	...
                	<td class="list_right_box" align="center">
                		<input class="mini-checkbox" id="overtime1" name="overtime1" value="${ckCheckInfo.overtime1}" trueValue="1" falseValue="0" valueField="text" url="../template/isOvertime.txt"/>
                	</td>
                	<td class="list_right_box" align="center">
                		<input class="mini-checkbox" id="overtime2" name="overtime2" value="${ckCheckInfo.overtime2}" trueValue="1" falseValue="0" valueField="text" url="../template/isOvertime.txt"/>
                	</td>
                	<td class="list_right_box" align="center">
                		<input class="mini-checkbox" id="overtime3" name="overtime3" value="${ckCheckInfo.overtime3}" trueValue="1" falseValue="0" valueField="text" url="../template/isOvertime.txt"/>
                	</td>
                	<td class="list_right_box" align="center">
                		<input class="mini-checkbox" id="overtime4" name="overtime4" value="${ckCheckInfo.overtime4}" trueValue="1" falseValue="0" valueField="text" url="../template/isOvertime.txt"/>
                	</td>
                	<td class="list_right_box" align="center">
                		<input class="mini-checkbox" id="overtime5" name="overtime5" value="${ckCheckInfo.overtime5}" trueValue="1" falseValue="0" valueField="text" url="../template/isOvertime.txt"/>
                	</td>
                	<td class="list_right_box" align="center">
                		<input class="mini-checkbox" id="overtime6" name="overtime6" value="${ckCheckInfo.overtime6}" trueValue="1" falseValue="0" valueField="text" url="../template/isOvertime.txt"/>
                	</td>
                	<td class="list_right_box" align="center">
                		<input class="mini-checkbox" id="overtime7" name="overtime7" value="${ckCheckInfo.overtime7}" trueValue="1" falseValue="0" valueField="text" url="../template/isOvertime.txt"/>
                	</td>
                	<td class="list_right_box" align="center">
                		<input class="mini-checkbox" id="overtime8" name="overtime8" value="${ckCheckInfo.overtime8}" trueValue="1" falseValue="0" valueField="text" url="../template/isOvertime.txt"/>
                	</td>
                	<td class="list_right_box" align="center">
                		<input class="mini-checkbox" id="overtime9" name="overtime9" value="${ckCheckInfo.overtime9}" trueValue="1" falseValue="0" valueField="text" url="../template/isOvertime.txt"/>
                	</td>
                	<td class="list_right_box" align="center">
                		<input class="mini-checkbox" id="overtime10" name="overtime10" value="${ckCheckInfo.overtime10}" trueValue="1" falseValue="0" valueField="text" url="../template/isOvertime.txt"/>
                	</td>
                	<td class="list_right_box" align="center">
                		<input class="mini-checkbox" id="overtime11" name="overtime11" value="${ckCheckInfo.overtime11}" trueValue="1" falseValue="0" valueField="text" url="../template/isOvertime.txt"/>
                	</td>
                	<td class="list_right_box" align="center">
                		<input class="mini-checkbox" id="overtime12" name="overtime12" value="${ckCheckInfo.overtime12}" trueValue="1" falseValue="0" valueField="text" url="../template/isOvertime.txt"/>
                	</td>
                	<td class="list_right_box" align="center">
                		<input class="mini-checkbox" id="overtime13" name="overtime13" value="${ckCheckInfo.overtime13}" trueValue="1" falseValue="0" valueField="text" url="../template/isOvertime.txt"/>
                	</td>
                	<td class="list_right_box" align="center">
                		<input class="mini-checkbox" id="overtime14" name="overtime14" value="${ckCheckInfo.overtime14}" trueValue="1" falseValue="0" valueField="text" url="../template/isOvertime.txt"/>
                	</td>
                	<td class="list_right_box" align="center">
                		<input class="mini-checkbox" id="overtime15" name="overtime15" value="${ckCheckInfo.overtime15}" trueValue="1" falseValue="0" valueField="text" url="../template/isOvertime.txt"/>
                	</td>
                	<td class="list_right_box" align="center">
                		<input class="mini-checkbox" id="overtime16" name="overtime16" value="${ckCheckInfo.overtime16}" trueValue="1" falseValue="0" valueField="text" url="../template/isOvertime.txt"/>
                	</td>
                	<td class="list_right_box" align="center">
                		<input class="mini-checkbox" id="overtime17" name="overtime17" value="${ckCheckInfo.overtime17}" trueValue="1" falseValue="0" valueField="text" url="../template/isOvertime.txt"/>
                	</td>
                	<td class="list_right_box" align="center">
                		<input class="mini-checkbox" id="overtime18" name="overtime18" value="${ckCheckInfo.overtime18}" trueValue="1" falseValue="0" valueField="text" url="../template/isOvertime.txt"/>
                	</td>
                	<td class="list_right_box" align="center">
                		<input class="mini-checkbox" id="overtime19" name="overtime19" value="${ckCheckInfo.overtime19}" trueValue="1" falseValue="0" valueField="text" url="../template/isOvertime.txt"/>
                	</td>
                	<td class="list_right_box" align="center">
                		<input class="mini-checkbox" id="overtime20" name="overtime20" value="${ckCheckInfo.overtime20}" trueValue="1" falseValue="0" valueField="text" url="../template/isOvertime.txt"/>
                	</td>
                	<td class="list_right_box" align="center">
                		<input class="mini-checkbox" id="overtime21" name="overtime21" value="${ckCheckInfo.overtime21}" trueValue="1" falseValue="0" valueField="text" url="../template/isOvertime.txt"/>
                	</td>
                	<td class="list_right_box" align="center">
                		<input class="mini-checkbox" id="overtime22" name="overtime22" value="${ckCheckInfo.overtime22}" trueValue="1" falseValue="0" valueField="text" url="../template/isOvertime.txt"/>
                	</td>
                	<td class="list_right_box" align="center">
                		<input class="mini-checkbox" id="overtime23" name="overtime23" value="${ckCheckInfo.overtime23}" trueValue="1" falseValue="0" valueField="text" url="../template/isOvertime.txt"/>
                	</td>
                	<td class="list_right_box" align="center">
                		<input class="mini-checkbox" id="overtime24" name="overtime24" value="${ckCheckInfo.overtime24}" trueValue="1" falseValue="0" valueField="text" url="../template/isOvertime.txt"/>
                	</td>
                	<td class="list_right_box" align="center">
                		<input class="mini-checkbox" id="overtime25" name="overtime25" value="${ckCheckInfo.overtime25}" trueValue="1" falseValue="0" valueField="text" url="../template/isOvertime.txt"/>
                	</td>
                	<td class="list_right_box" align="center">
                		<input class="mini-checkbox" id="overtime26" name="overtime26" value="${ckCheckInfo.overtime26}" trueValue="1" falseValue="0" valueField="text" url="../template/isOvertime.txt"/>
                	</td>
                	<td class="list_right_box" align="center">
                		<input class="mini-checkbox" id="overtime27" name="overtime27" value="${ckCheckInfo.overtime27}" trueValue="1" falseValue="0" valueField="text" url="../template/isOvertime.txt"/>
                	</td>
                	<td class="list_right_box" align="center">
                		<input class="mini-checkbox" id="overtime28" name="overtime28" value="${ckCheckInfo.overtime28}" trueValue="1" falseValue="0" valueField="text" url="../template/isOvertime.txt"/>
                	</td>
                	<td id="tr3td29" class="list_right_box" align="center">
                		<input class="mini-checkbox" id="overtime29" name="overtime29" value="${ckCheckInfo.overtime29}" trueValue="1" falseValue="0" valueField="text" url="../template/isOvertime.txt"/>
                	</td>
                	<td id="tr3td30" class="list_right_box" align="center">
                		<input class="mini-checkbox" id="overtime30" name="overtime30" value="${ckCheckInfo.overtime30}" trueValue="1" falseValue="0" valueField="text" url="../template/isOvertime.txt"/>
                	</td>
                	<td id="tr3td31" class="list_right_box" align="center">
                		<input class="mini-checkbox" id="overtime31" name="overtime31" value="${ckCheckInfo.overtime31}" trueValue="1" falseValue="0" valueField="text" url="../template/isOvertime.txt"/>
                	</td>
                </tr>
                <tr>
                ...
                <tr>
                	...
                	<td id="tr6td29" class="list_right_box" style="text-decoration: none;text-align:center" colspan="31">
                		<input id="remark" name="remark" vtype="maxLength:200" class="mini-textarea"
    ...
    <script type="text/javascript">
        ...
        function onOk(){
            ...
            $.ajax({
                url: "../check/check_infos!saveOrUpdate.action",
                data:{
                	formdata:json
                },
                success: function (text) {
