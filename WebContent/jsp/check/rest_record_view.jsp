		...
		<div>
			...
			<table cellpadding="0" cellspacing="0" border="0" class="addtable" width="90%" align="center">
                ...
                <tr>
                    ...
                    <td class="list_right_box">
                        <input class="mini-textbox" value="${evection.restDay}" enabled="false"
                            required="true" requiredErrorText="不能为空" vtype="maxLength:10" width="150px"/>
                    </td>
                ...
                <tr>
                	...
                	<td class="list_right_box" colspan="3">
                		<input name="field1" id="field1" class="mini-textarea" value="${evection.field1}" enabled="false"
                ...
                <tr>
                    ...
                    <td class="list_right_box" colspan="3">
                        <input class="mini-textarea" value="${evection.remark}" enabled="false"
                            required="true" requiredErrorText="不能为空" vtype="maxLength:1000" 
