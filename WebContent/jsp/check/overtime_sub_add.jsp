...
<body>
	<form id="form1" method="post">
		<div>
			...
			<input class="mini-hidden" name="nodeId" id="nodeId" value="${advid}" style="display:none;"/> 
			...
			<table cellpadding="0" cellspacing="0" border="0" class="addtable" width="90%" align="center">
				...
				<tr>
					...
					<td class="list_right_box">
                        <input name="auditStatus"  id="auditStatus" required="true" 
					...
					<td align="left" class="list_left_box1" > 
                        <input id="nodeId"  name="field1"  
							class="mini-combobox" textField="text" valueField="id" emptyText="0"  
							width="90%" value="" url=""/>
                    </td>
				</tr> 
				...
				<tr>
					...
					<td align="left" class="list_left_box1" colspan="3"> 
                        <input id="postid"  class="mini-combobox" textField="text" 
                        onvaluechanged="onDeptChanged"  valueField="id" emptyText="" width="450px"
                         url="../system/work_flow!getNextCheckDept.action?pid=${advid}&nodeid=${nodeId}"/>
                    </td>
				</tr>
			</table>
		</div>
		<div class="mini-toolbar"
			...
			<a class="mini-button" id="ok" onclick="onOk(1)" iconCls="icon-save" tyle="width:60px;margin-right:20px;" iconCls="icon-save">驳回</a>  
...
<script type="text/javascript">
    ...
    var positionCombo = mini.get("nodeId");
