...
<body>
    ...
    <div class="mini-fit">
        <div id="grid" class="mini-datagrid" style="width:100%;height:100%;" 
             url="../check/evection!getAuditData.action" idField="id" multiSelect="true" 
            ...
            <div property="columns">
                ...
                <div field="evectionType" width="120" headerAlign="center" align="center" >出差类型</div>
                <div field="beginTime" width="160" headerAlign="center" align="center" >出差开始时间</div>
                <div field="endTime" width="160" headerAlign="center" align="center" >出差结束时间</div>
                <div field="evectionDays" width="80" headerAlign="center" align="center" >出差天数</div>
    ...
    <script type="text/javascript">
        ...
        function view(id) {
        	mini.open({
					url : "../check/evection!view.action?id=" + id,
					title : "查看申请信息",
					width : 600,
					height : 350,
					/* allowResize:false, */
	    ...
	    function audit(){
			...
			if (rows.length <= 0){
				...
				mini.open({
						url : "../check/evection!showApprove.action?id=",
						title : "填写审核意见",
						width : 750,
						height : 410,
						allowResize : false,
