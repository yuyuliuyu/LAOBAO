        ...
        <table cellpadding="0" cellspacing="0" border="0" class="addtable" width="100%">
            <tr>
                ...
                <td class="list_right_box" width="30%">
                    <input name="positionId" id="positionId" class="mini-buttonedit" value="${postPosition.id}" required="true"
            ...
            <tr>
                ...
                <td class="list_right_box">
                        <input id="postType" name="postType" class="mini-combobox" style="width:200px;" value="${deptPosition.postType}"  textField="dicname" valueField="dicvalue"
            ...
            <tr>
                ...
                <td class="list_right_box">
                        <input id="postOrder" name="postOrder" class="mini-combobox" style="width:200px;" value="${deptPosition.postOrder}"  textField="dicname" valueField="dicvalue"
            ...
            <tr>
                ...
                <td class="list_right_box" colspan="3">
                    <input name="postExplain" id="postExplain" class="mini-textbox" value="${deptPosition.postExplain}"
                            vtype="maxLength:20;" width="100%"/></td> 
            </tr>
            <tr>
