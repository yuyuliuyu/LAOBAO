  ...
  <body>
	...
	<div class="mini-fit">
        ...
        <table cellpadding="0" cellspacing="0" border="0" class="addtable" width="90%" align="center">
                ...
                <tr>
               		<td align="left" class="list_left_box1"  height="30px" ><b>工作组信息：</b></td> 
                ...
                <tr>
               		<td align="left" class="list_left_box1"  height="30px" ><b>成员信息：</b></td> 
               		<td align="left" class="list_left_box1"  colspan="3" > </td> 
                </tr>
                
                <tr>
                   <td class="list_left_box1" valign="top">党员姓名：</td>
                    <td class="list_right_box">
                        <input name="xh" id="xh" class="mini-textbox" value="${cd.xh}"  width="100%" />
                    </td> 
                    <td class="list_left_box1" valign="top">角色：</td>
                    <td class="list_right_box">
                        <input name="xh" id="xh" class="mini-textbox" value="${cd.xh}"  width="100%" />
                    </td>   
                </tr> 
                <tr>
                   <td class="list_left_box1" valign="top">角色描述：</td>
