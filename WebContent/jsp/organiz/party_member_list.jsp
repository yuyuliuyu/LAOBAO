...
<body>
	            ...
	            <div class="mini-toolbar" style="padding:0px;border-top:0;">
	       			 <table style="width:100%;">
			                ...
			                <td style="width:100%;">
			                    ...
			                    <a class="mini-button" iconCls="icon-zhuanyibumen" onclick="leaveparty()">办理出党</a>  
			                    <a class="mini-button" iconCls="icon-upgrade" onclick="recoveryparty()">恢复党籍</a>
			                    <a class="mini-button" iconCls="icon-upgrade" onclick="nbzj()">内部转接</a>
			                    <a class="mini-button" iconCls="icon-upgrade" onclick="wbdl()">外部调离</a>
			                    <a class="mini-button" iconCls="icon-upgrade" onclick="wbdr()">外部调入</a>
			                </td>
	            		 </tr>
	        		</table>
	    		</div>
	    		<div id="grid1" class="mini-datagrid" style="width:100%;height:94%;"showTreeIcon="true"
		             treeColumn="name" idField="did" parentField="pid" resultAsTree="false" allowResize="false" expandOnLoad="true">
		                <div property="columns">
	                        ...
	                        <div field="name" id ="name" name = "name"width="100" headerAlign="center" align="left">转正日期</div> 
	                        <div field="name" id ="name" name = "name"width="100" headerAlign="center" align="left">员工状态</div> 
    ...
    grid.load();
        function add() { 
    			 mini.open({
    	                url : "../organiz/party_member!add.action",
    	                title : "添加信息",
    	                width : 770,
    	                height : 540,
    	                /* allowResize : false, */
       ...
       function leaveparty(){
			 mini.open({
	                url : "../organiz/party_relation!cdadd.action",
	                title : "办理出党",
	                width : 770,
	                height : 540,
	                /* allowResize : false, */
       ...
       function recoveryparty(){
			 mini.open({
	                url : "../organiz/party_relation!rdadd.action",
	                title : "恢复党籍",
	                width : 770,
	                height : 540,
	                /* allowResize : false, */
       ...
       function wbdr(){
			 mini.open({
	                url : "../organiz/party_relation!dradd.action",
	                title : "外部调入",
	                width : 770,
	                height : 630,
	                /* allowResize : false, */
