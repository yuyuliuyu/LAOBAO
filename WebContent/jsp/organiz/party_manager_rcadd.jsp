  ...
  <body>
	...
	<div class="mini-fit">
        ...
        <table cellpadding="0" cellspacing="0" border="0" class="addtable" width="90%" align="center">
                ...
                <tr>
               		<td align="left" class="list_left_box1"  height="30px" ><b>日常活动信息：</b></td> 
                ...
                <tr> 
                   <td class="list_left_box1" valign="top">名称：</td>
                    ...
                    <td class="list_left_box1" valign="top">举办日期：</td>
                    <td class="list_right_box">
                ...
                <tr>
                    <td class="list_left_box1" valign="top">地点：</td>
                    <td class="list_right_box">
