...
<body>
	            ...
	            <div class="mini-toolbar" style="padding:0px;border-top:0;">
	       			 <table style="width:100%;">
			                ...
			                <td style="width:100%;">
			                    ...
			                    <a class="mini-button" iconCls="icon-user" onclick="personinfo()">申请入党</a>
	    		...
	    		<div id="grid1" class="mini-datagrid" style="width:100%;height:94%;"showTreeIcon="true"
		             treeColumn="name" idField="did" parentField="pid" resultAsTree="false" allowResize="false" expandOnLoad="true">
		                <div property="columns">
	                        ...
	                        <div field="name" id ="name" name = "name"width="100" headerAlign="center" align="left">进入党组织日期</div> 
    ...
    grid.load();
        function add() {
    			 ...
    			 mini.open({
    	                url : "../organiz/party_member!qzadd.action",
    	                title : "添加信息",
    	                width : 770,
    	                height : 540,
    	                /* allowResize : false, */
