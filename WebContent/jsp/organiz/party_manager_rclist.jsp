...
<body>
	    		...
	    		<div id="grid1" class="mini-datagrid" style="width:100%;height:94%;"showTreeIcon="true"
		             treeColumn="name" idField="did" parentField="pid" resultAsTree="false" allowResize="false" expandOnLoad="true">
		                <div property="columns">
	                        ...
	                        <div field="name" id ="name" name = "name"width="100" headerAlign="center" align="left">举办日期</div>
	                        <div field="name" id ="name" name = "name"width="100" headerAlign="center" align="left">地点</div>
    ...
    grid.load();
        function add() {
    			 ...
    			 mini.open({
    	                url : "../organiz/party_manager!rcadd.action",
    	                title : "添加信息",
    	                width : 770,
    	                height : 540,
    	                /* allowResize : false, */
