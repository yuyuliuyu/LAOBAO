  ...
  <body>
	...
	<div class="mini-fit">
        ...
        <table cellpadding="0" cellspacing="0" border="0" class="addtable" width="90%" align="center">
              	<tr> 
               		<td align="left"   colspan="4" height="1px"> &nbsp;</td> 
                </tr> 
                <tr>
               		<td align="left" class="list_left_box1"  height="20px" ><b>党组织信息：</b></td> 
                ...
                <tr>
               		<td align="left" class="list_left_box1"  height="20px" ><b>党员信息：</b></td> 
               		<td align="left" class="list_left_box1"  colspan="3" > </td> 
                </tr> 
                ...
                <tr>
                   ...
                   <td class="list_left_box1" valign="top">预备期满日期：</td>
                    <td class="list_right_box">
                       <input class="mini-datepicker" format="yyyy-MM-dd" readonly="readonly" 
									name="date" style="width: 96%" msg="日期格式不正确" allowInput="false"
									 value="${laweFormArchfiling.date}"/>
                ...
                <tr>
                    <td class="list_left_box1" valign="top">转正日期：</td>
                    <td class="list_right_box">
                       <input class="mini-datepicker" format="yyyy-MM-dd" readonly="readonly" 
									name="date" style="width: 96%" msg="日期格式不正确" allowInput="false"
									 value="${laweFormArchfiling.date}"/>
                    </td>   
                   <td class="list_left_box1" valign="top">转正情况：</td>
                    <td class="list_right_box">
                        <input name="xh" id="xh" class="mini-textbox" value="${cd.xh}"  width="100%" />
                    </td> 
                </tr>   
                <tr>
                   <td class="list_left_box1" valign="top">延长原因：</td>
               ...
               <tr> 
                ...
                <tr>
               		<td align="left" class="list_left_box1"  height="20px" ><b>调入信息：</b></td> 
               		<td align="left" class="list_left_box1"  colspan="3" > </td> 
                </tr> 
                <tr>
                   <td class="list_left_box1" valign="top" >原党组织： </td> 
                   <td class="list_left_box1" valign="top" >
                        <input name="xh" id="xh" class="mini-textbox" value="${cd.xh}"  width="100%" /> </td> 
                    <td class="list_left_box1" valign="top">创建日期：</td>
                    <td class="list_right_box">
                       <input class="mini-datepicker" format="yyyy-MM-dd" readonly="readonly" 
									name="date" style="width: 96%" msg="日期格式不正确" allowInput="false"
                ...
                <tr>
                   <td class="list_left_box1" valign="top">转入日期：</td>
                    <td class="list_right_box">
                       <input class="mini-datepicker" format="yyyy-MM-dd" readonly="readonly" 
									name="date" style="width: 96%" msg="日期格式不正确" allowInput="false"
									 value="${laweFormArchfiling.date}"/>
                ...
                <tr>
                   <td class="list_left_box1" valign="top">转入原因：</td>
                    <td class="list_right_box" colspan="3">
  					<textarea name="xh" id="xh" class="mini-textarea" value="${cd.xh}" emptyText="请输入备注" style="width: 100%;height:50px"></textarea>
                    </td>  
                </tr>
