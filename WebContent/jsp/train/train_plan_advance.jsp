  ...
  <body>
	<div class="mini-fit">
        ...
        <table cellpadding="0" cellspacing="0" border="0" class="addtable" width="90%" align="center">
                ...
                <tr>
               		<td align="left" class="list_left_box1"  height="20px"   width="80px"><b>审批内容：</b></td> 
               		<td align="left" class="list_left_box1"  colspan="3" > </td> 
                </tr> 
                <tr>
                   <td class="list_left_box1" valign="top">模块名称：</td>
                    <td class="list_right_box">
                        <input name="xh" id="xh" class="mini-textbox" value="${cd.xh}"  width="100%" />
                    </td> 
                    <td class="list_left_box1" valign="top"  width="80px">审批结果：</td>
                    <td class="list_right_box">
                        <input name="xh" id="xh" class="mini-textbox" value="${cd.xh}"  width="100%" />
                    </td>   
                </tr> 
                <tr>
                   <td class="list_left_box1" valign="top">意见：</td>
                ...
                <tr>
                   <td class="list_left_box1" valign="top">审批人：</td>
                    ...
                    <td class="list_left_box1" valign="top">审批时间：</td>
                    <td class="list_right_box">
