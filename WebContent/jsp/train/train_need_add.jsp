  ...
  <body>
	...
	<div class="mini-fit">
        ...
        <table cellpadding="0" cellspacing="0" border="0" class="addtable" width="90%" align="center">
                ...
                <tr>
               		<td align="left" class="list_left_box1"  height="20px"  width="80px"><b>培训要求：</b></td> 
                ...
                <tr>
                   <td class="list_left_box1" valign="top">姓名：</td>
                    ...
                    <td class="list_left_box1" valign="top"  width="80px">部门：</td>
                    <td class="list_right_box">
                    </td>   
                </tr>
                <tr>
                   <td class="list_left_box1" valign="top">培训形式：</td>
                    <td class="list_right_box">
                        <input name="xh" id="xh" class="mini-textbox" value="${cd.xh}"  width="100%" />
                    </td> 
                    <td class="list_left_box1" valign="top">提报时间：</td>
                    <td class="list_right_box">
                ...
                <tr>
                   <td class="list_left_box1" valign="top">培训内容：</td>
