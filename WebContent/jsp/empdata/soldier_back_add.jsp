...
<body>
        ...
        <div id="zhuanzheng" style="display:none">	
			...
			<table cellpadding="0" cellspacing="0" border="0" class="addtable" width="100%">
                ...
                <tr>
                    ...
                    <td class="list_left_box1" valign="top" width="15%">入伍时间：</td>
                    <td class="list_right_box" width="30%">
                        <input class="mini-datepicker" format="yyyy-MM-dd"
							id="insolDate" name="insolDate" style="width: 90%" msg="日期格式不正确" allowInput="false"
									required="true" value="${soba.insolDate}"/>
                    </td> 
                    <td class="list_left_box1" valign="top" width="15%">复转时间：</td>
                    <td class="list_right_box" width="30%">
                        <input class="mini-datepicker" format="yyyy-MM-dd"
							id="outsolDate" name="outsolDate" style="width: 90%" msg="日期格式不正确" allowInput="false"
									required="true" value="${soba.outsolDate}"/>
                    </td> 
                </tr>
                <tr>
                    
                    <td class="list_left_box1" valign="top" width="15%">复转类别：</td>
                    <td class="list_right_box" width="30%">
                        <input id="solType" name="solType" class="mini-combobox" style="width:90%;" value="${soba.solType}"  textField="dicname" valueField="dicvalue"
		                   		url="../system/dectionary!listjson.action?id=402881955c3ea11f015c3ea6bdcc0008" showNullItem="true" emptyText="请选择..." nullItemText="请选择..." />
                    </td> 
                    <td class="list_left_box1" valign="top" width="15%">复转前级别：</td>
                    <td class="list_right_box" width="30%">
                        <input id="solLevel" name="solLevel" class="mini-combobox" style="width:90%;" value="${soba.solLevel}"  textField="dicname" valueField="dicvalue"
		                   		url="../system/dectionary!listjson.action?id=402881955c3ea11f015c3ea71e700009" showNullItem="true" emptyText="请选择..." nullItemText="请选择..." />
                    </td> 
                </tr>
                ...
                <tr>
                    ...
                    <td class="list_right_box" width="30%">
                        <input name="solDuty" id="solDuty" class="mini-textbox" value="${soba.solDuty}"
                               style="width:90%;"/>
                    </td> 
                    <td class="list_left_box1" valign="top" width="15%">军衔：</td>
                    <td class="list_right_box" width="30%">
                        <input name="solRank" id="solRank" class="mini-textbox" value="${soba.solRank}"
                               style="width:90%;"/>
                    </td> 
                </tr>
                <tr>
                    
                    <td class="list_left_box1" valign="top" width="15%">部队：</td>
                    <td class="list_right_box" width="30%">
                        <input name="troops" id="troops" class="mini-textbox" value="${soba.troops}"
                               style="width:90%;"/>
                    </td> 
                ...
                <tr>
                    ...
                    <td class="list_right_box" colspan="3">
                         <input id="remark" name="remark" class="mini-textarea" value="${soba.remark}"  maxlength="500"style="width: 96%;height:50px"/>
                    </td> 
                </tr>
                <tr>
    ...
    <script type="text/javascript">
		...
		function onOk(){
            ...
            //strut令牌
            $.ajax({
                url: "../empdata/soldier_back!saveOrUpdate.action",
                data:{
                	formdata:json,
                },
