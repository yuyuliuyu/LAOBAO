...
<body>
    ...
    <div class="mini-toolbar" style="border-left:0;padding:0px;">
		<table style="width:100%;">
			<tr>
				<td>
					<tags:hasPerm value="../empdata/punish!add.action">
					<a class="mini-button" iconCls="icon-add" onclick="add()">添加</a>
					</tags:hasPerm>
					<tags:hasPerm value="../empdata/punish!edit.action">
					<a class="mini-button" iconCls="icon-edit" onclick="edit()">编辑</a>
					</tags:hasPerm>
					<tags:hasPerm value="../empdata/punish!remove.action">
    ...
    <div class="mini-fit">
        <div id="grid" class="mini-datagrid" style="width:100%;height:100%;" 
             url="../empdata/punish!getListData.action?personId=${personId}" idField="id" multiSelect="true" 
    ...
    function add() {
    	mini.open({
    	   url : "../empdata/punish!add.action?personId=${personId}",
    	   title : "添加信息",
    	   width : 770,
    	   height : 540,
    	   onload : function() {
  ...
  //***************编辑方法**********************//
	function edit() {
   	 ...
   	 if (row) {
    		mini.open({
               	 url : "../empdata/punish!add.action?personId=${personId}&id="+row.id,
                 title : "编辑人员信息",
       		     width : 900,
        		 height : 600,
         		 onload : function() {
