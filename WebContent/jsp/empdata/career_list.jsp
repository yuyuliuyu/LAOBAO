...
<body>
	...
	<div class="mini-toolbar" style="padding:0px;border-top:0;">
		<table style="width:100%;">
			<tr>
				<td style="width:100%;">
					<tags:hasPerm value="../empdata/career!add.action">
					<a class="mini-button" iconCls="icon-add" onclick="add()">增加</a>
					</tags:hasPerm>
					<tags:hasPerm value="../empdata/career!edit.action">
    ...
    function add() {
    	mini.open({
    	   url : "../empdata/career!add.action?personId=${personId}",
    	   title : "添加信息",
    	   width : 770,
    	   height : 540,
    	   onload : function() {
  ...
  //***************编辑方法**********************//
	function edit() {
   	 ...
   	 if (row) {
    		mini.open({
               	 url : "../empdata/career!add.action?personId=${personId}&id="+row.id,
                 title : "编辑人员信息",
       		     width : 900,
        		 height : 600,
         		 onload : function() {
	...
	function remove() {
		...
		if (rows.length > 0) {
				if (confirm("确定删除选中记录？")) {
					...
					var sid = ids.join(',');
					$.ajax({
					url : "../empdata/career!remove.action?ids=" + sid,
					type : "post",
