...
<body>
   <form id="form" method="post">
        <input  name="id" id="id" value="${backendRole.id}" style="display:none;"/>
        ...
        <div class="mini-toolbar" style="text-align:center;line-height:30px;" 
            ...
            <label >角色名称:</label>
            <%if(id.equals("null")){ %>
                <input id="rname" class="mini-textbox" style="width:150px;" value="${branch2.fzx}" 
            ...
            <input id="desc" class="mini-textbox" style="width:150px;" required="true" requiredErrorText="不能为空" 
                   value="${branch2.remark}" vtype="maxLength:100"/>
                   </td>
        </div>
    </form> 
    ...
    <script type="text/javascript">
        ...
        function onOk() {
           ...
           // var json = mini.encode(data);
            ...
            $.ajax({
                url : "../laobao/gang_wei!saveOrUpdate.action",
                type : "post",
                data : {
                     name : mini.get("rname").getValue(),desc:mini.get("desc").getValue()
                },
