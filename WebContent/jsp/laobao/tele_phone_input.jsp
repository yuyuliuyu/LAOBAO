	...
	<%-- 	<div size="260" showCollapseButton="true">
		...
		<div showCollapseButton="flase">
		            ...
		            <tr>
 		                  <td style="width:200px;">职工号：
            			    ...
            			    <td style="width:200px;">姓名：
                   				 <input id="name" name="name" class="mini-textbox"  onenter="onKeyEnter"/>
              			   </td>
              			    <td style="width:200px;">物品名称：
                   				 <input id="wpmc" name="wpmc" class="mini-textbox"  onenter="onKeyEnter"/>
              			   </td>
		            
		                 <td style="width:200px;">创建时间： <input
		                    class="mini-textbox" id="createdate" name="createdate"
		                     onenter="onKeyEnter" />
		                </td>
		                 <td style="width:200px;">下次时间： <input
		                    class="mini-textbox" id="nextdate" name="nextdate"
		                     onenter="onKeyEnter"  />
		                </td>

               			   <td style="white-space:nowrap;">
                 			   <a id="searchButton" class="mini-button" iconCls="icon-search" onclick="search('jobNumber,name,wpmc,createdate,nextdate','jobNumber,name,wpmc,createdate,nextdate')" onenter="onKeyEnter">查询</a>
               			   </td>
		            </tr>
		        </table>
		    </div>
		    <div class="mini-toolbar" style="border-left:0;padding:0px;">
		        <table style="width:100%;">
		            <tr>
		                <td><a class="mini-button" iconCls="icon-upload" onclick="exportClassInfo()">导出</a> 
