...
<body>
    ...
    <div class="mini-fit" >
        <div id="dept_grid" class="mini-datagrid" style="width:100%;height:100%;"
             url="gang_wei!json.action" resultAsTree="false" allowResize="false"
            ...
            <div property="columns">
                ...
                <div field="name" name="name" width="100" headerAlign="center" align="center">岗位名称</div>
                <div field="description" name="description" width="100" headerAlign="center" align="center">岗位描述</div>
    ...
    <script type="text/javascript">
        ...
        function add() {
            mini.open({
                url: "../laobao/gang_wei!function.action?id=null",
                title: "新增角色",
                width: 600,
                height: 200,
                /* allowResize : false, */
        ...
        function edit() {
            ...
            if (row) {
                mini.open({
                    url: "../laobao/gang_wei!function.action?id="+row.id,
                    title: "编辑角色",
                     width: 810,
               		 height: 450,
                    /* allowResize : false, */
        ...
        function remove() {
            ...
            if (row) {
                mini.confirm("您确定要删除该信息吗？","提醒",function(action){
                    if(action=="ok"){
                        $.ajax({
                            url: "gang_wei!delete.action?id=" +row.id,
                            success: function (text) {
                                if(text=="success"){
                                    dept_grid.reload();
                                    mini.alert("删除成功！");
