...
<body>
    <div class="mini-tabs" style="width:100%;height:100%">
        <div title="员工缴费计算过程">
                                  ...
                                  showToolbar="true" showCloseButton="true" showHeader="false" bodyStyle="padding:0"  borderStyle="border:0">
                                    <div property="toolbar" style="padding:5px;padding-left:8px;text-align:center;">
                                        <div style="float:left;padding-bottom:2px;">
                                           <span>编码：</span>
                                           <input id="bm" class="mini-textbox" onenter="onButtonEditJfComAlert"/>
                                           <span>名称：</span>
            ...
            <div class="mini-toolbar" style="text-align:center;padding-top:8px;padding-bottom:8px;" borderStyle="border:0;">
                <a class="mini-button" onclick="onOK()" name="status" style="width:60px;margin-right:20px;" iconCls="icon-save">保存</a>
                ...
                <table style="width:100%;">
                    <tr>
                        <td style="width:100%;">
                            ...
                            <br><a class="mini-button" iconCls="icon-add" name="status" onclick="choosePerson()">增加</a>
                            <a class="mini-button" iconCls="icon-edit" name="status" onclick="editInsurance()">编辑</a>
                            <a class="mini-button" iconCls="icon-remove" name="status" onclick="removeRows()">删除</a>
                            <a class="mini-button" iconCls="icon-save" name="status" onclick="save()">保存</a>
                            <a class="mini-button" iconCls="icon-reload" name="status" onclick="reJs()">重新计算</a>
                        </td>
                    </tr>
                </table>
            </div>
    ...
    <script type="text/javascript">
        ...
        $(function() {
            ...
            // 根据分配过程是否创建是否显示某些按钮
            var checkStatus = '${mapInfo.processStatus}';
            if (checkStatus == 1) {
                ...
                mini.alert("薪酬核算过程已经创建或者已经提交、已通过不能修改");
            }
        });
        ...
        function choosePerson() {
            ...
            mini.open({
                url : "../salary/salary_payment!person.action?id="+process+"&ids="+deptId+"&year="+effectiveYear+"&month="+effectiveMonth,
                title : "选择员工",
                width : 680,
                height : 540,
                onload : function() {
        ...
        function reJs() {
            ...
            mini.confirm("确定要重新计算所有员工缴费记录？", "提醒", function(action) {
                if (action == "ok") {
                    window.parent.loading();
                    $.ajax({
        ...
        function onButtonEditJfComAlert(e) {
            ...
            datagrid1.load({companyName: mini.get("companyName").getValue(), bm : mini.get("bm").getValue()});
        }
