...
<body>
    <div class="mini-splitter" style="width:100%;height:100%;" borderStyle="border:0">
        <div size="16%" showCollapseButton="true">
            ...
            <div class="mini-fit" style=" border-top:0;">
                <ul id="tree1" class="mini-tree" url="../basis/branch!getDataAuth.action" style="width:100%;height:100%;"
                             ...
                             <div size="50%">
                                ...
                                <div class="mini-fit">
                                    <div id="zjjfblGrid" class="mini-datagrid" style="width:100%;height:100%;"borderStyle="border:0;"
                                        url="../salary/salary_nj!getZjjfblData.action"
                                        ...
                                        <div property="columns">
                                            ...
                                            <div type="comboboxcolumn" field="deptLevel" width="120" headerAlign="center" align="center" vtype="required;">职级类别
                                                <input property="editor" class="mini-combobox" url="../system/dectionary!listjson.action?id=402881aa5db0fa65015db10c2ab4000f"
                             ...
                             <div>
                                ...
                                <div class="mini-fit">
                                    <div id="nlqxxsGrid" class="mini-datagrid" style="width:100%;height:100%;"borderStyle="border:0;"
                                        url="../salary/salary_nj!getNlqxxsData.action"
                                        allowCellEdit="true"  allowCellSelect="true" pageSize="20" showPager="false">
                                        <div property="columns">
                                            <div field="id" id="id" width="10" name="id" class="mini-hidden"></div>
                                ...
                                <div class="mini-fit">
                                    <div id="nlxsGrid" class="mini-datagrid" style="width:100%;height:100%;"borderStyle="border:0;"
                                        ...
                                        <div property="columns">
                                            ...
                                            <div field="ctr" width="80" headerAlign="center" align="center">操作</div>
                                        </div>
                                    </div>
                                </div>
                             </div>
                             <div>
                                ...
                                <div class="mini-fit">
                                    <div id="nljzDateGrid" class="mini-datagrid" style="width:100%;height:100%;"borderStyle="border:0;"
                                        url="../salary/salary_nj!getNlJzDateData.action"
                                        allowCellEdit="true"  allowCellSelect="true" pageSize="20" showPager="false">
                                        <div property="columns">
                                            <div field="id" id="id" width="10" name="id" class="mini-hidden"></div>
                                    ...
                                    <table style="width:100%;" cellpadding="0" cellspacing="0" border="0">
                                        <tr>
                                            ...
                                            <td class="list_right_box">
                                                ...
                                                <input class="mini-textbox asLabel" name="compnayName" allowInput="false" style="width: 90%" />
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="list_left_box1" valign="top">参加年金计划人数：</td>
                                            <td class="list_right_box">
                                                <input class="mini-textbox asLabel" name="cjnjjhrs" allowInput="false" style="width: 90%" />
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="list_left_box1" valign="top">暂停缴费人数</td>
                                            <td class="list_right_box">
                                                <input class="mini-textbox asLabel" name="ztjfrs" allowInput="false" style="width: 90%" />
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="list_left_box1" valign="top">上年度企业月工资总额</td>
                                            <td class="list_right_box">
                                                <input class="mini-textbox asLabel" name="sndqyygzze" allowInput="false" style="width: 90%" />
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="list_left_box1" valign="top">企业缴费比例</td>
                                            <td class="list_right_box">
                                                <input class="mini-spinner" style="width: 90%" id= "qyjfbl" name="qyjfbl" 
                                        ...
                                        <tr>
                                            ...
                                            <td class="list_right_box">
                                                <input class="mini-textbox asLabel" name="qyjfze" allowInput="false" style="width: 90%" />
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="list_left_box1" valign="top">月倾斜性缴费总额</td>
                                            <td class="list_right_box">
                                                <input class="mini-textbox asLabel" name="yqxxjfze" allowInput="false" style="width: 90%" />
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="list_left_box1" valign="top">月基本缴费总额</td>
                                            <td class="list_right_box">
                                                <input class="mini-textbox asLabel" name="yjbjfze" allowInput="false" style="width: 90%" />
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="list_left_box1" valign="top">倾斜性缴费占比</td>
                                            <td class="list_right_box">
                                                <input class="mini-spinner asLabel" name="qxxjfzb" allowInput="false" style="width: 90%" 
                                                    minValue="-1" maxValue="1" format="p2"/>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="list_left_box1" valign="top">基本缴费占比</td>
                                            <td class="list_right_box">
                                                <input class="mini-spinner asLabel" name="jbjfzb" allowInput="false" style="width: 90%" 
                                                    minValue="-1" maxValue="1" format="p2"/>
                                            </td>
                                        </tr>
                                    </table>
                ...
                <div title="数据计算">
                        ...
                        <table style="width:100%;">
                            <tr>
                                <td style="width:100%;">
                                    ...
                                    <br><a class="mini-button" iconCls="icon-save" onclick="saveNj()">保存</a>
                    ...
                    <div class="mini-fit">
                        <div id="grid" class="mini-datagrid" style="width:100%;height:100%;"borderStyle="border:0;"
                            allowHeaderWrap="true" pageSize="20" showPager="false" showSummaryRow="true" 
                            allowCellEdit="true"  allowCellSelect="true" oncellendedit="onNjCellEndEdit" ondrawsummarycell="onDrawSummaryCell">
                            <div property="columns">
                                <div field="id" id="id" width="10" name="id" class="mini-hidden"></div>
                                ...
                                <div type="comboboxcolumn" field="deptLevel" width="100" headerAlign="center" align="center"vtype="required;">职级类别*
                                    <input property="editor" class="mini-combobox"popupWidth="auto" url="../system/dectionary!listjson.action?id=402881aa5db0fa65015db10c2ab4000f"
                                         textField="dicname" valueField="dicvalue"/>
                                </div>
                                <div type="comboboxcolumn" field="sflb" width="60" headerAlign="center" align="center"vtype="required;">身份类别*
                                    <input property="editor" class="mini-combobox"popupWidth="auto" data="[{id:1,text:'干部'},{id:2,text:'工人'}]"/>
                                </div>
                                ...
                                <div type="comboboxcolumn" field="sex" readOnly="false" width="40" headerAlign="center" align="center">性别
                                    <input property="editor" class="mini-combobox" data="[{id:0, text:'女'},{id:1, text:'男'}]"/>
                                </div>
                                <div field="isStop" width="60" headerAlign="center" align="center" vtype="int;required;">停止缴费*
                                    <input property="editor" class="mini-spinner" minValue="0" maxValue="1"/>
                                </div>
                                <div field="endAge" name="endAge" width="60" headerAlign="center" align="center">截至年龄</div>
    ...
    <script type="text/javascript">
        ...
        tree.on("nodeselect", function (e) {
            ...
            if (node) {
                var dId = node.branchId;
                zjjfblGrid.load({companyId: dId});
                nlqxxsGrid.load({companyId: dId});
                nlxsGrid.load({companyId: dId});
                nljzDateGrid.load({companyId: dId});
                grid.setUrl("../salary/salary_nj!getNjListData.action?companyId="+dId);
                $("#searchButton").click();
                var form = new mini.Form("#form1");
                window.parent.loading();
                $.ajax({
                    url: "../salary/salary_nj!getTotalData.action",
                    data: {
                        companyId: dId
                    },
                    type: "post",
                    success: function (text) {
                        ...
                        form.setData(data);
                        grid.updateColumn("endAge", { header: "截至"+data.ageEnd+"年龄" });
                    }
                });
            } 
        });
        ...
        function reInit() {
            ...
            mini.confirm("确定要重新初始化？","提醒",function(action) {
                if (action == "ok") {
                    window.parent.loading();
                    $.ajax({
                        url : "../salary/salary_nj!updateInit.action?qyjfbl="+mini.get("qyjfbl").getValue()+"&companyId="+node.branchId,
                        type : "post",
                        success : function(text) {
                            window.parent.unmask();
                            if (text == "success") {
                                $.ajax({
                                    url : "../salary/salary_nj!updateReCalculate.action?qyjfbl="+mini.get("qyjfbl").getValue()+"&companyId="+node.branchId,
                                    type : "post",
                                    success : function(text) {
                                        window.parent.unmask();
                                        if (text == "success") {
        ...
        function saveNj() {
            ...
            window.parent.loading();
            $.ajax({
                url : "../salary/salary_nj!saveOrUpdateNjTotal.action",
                type : "post",
                data : {
                	griddata : gridjson,
                    companyId: node.branchId
        ...
        function onNjCellEndEdit(e) {
        	var record = e.record, field = e.field, row = e.row;
            // 职务级别
            if (field=="deptLevel") {
                var node = tree.getSelectedNode();
                window.parent.loading();
                $.ajax({
                    url : "../salary/salary_nj!getDeptLevelData.action",
                    type : "post",
                    data : {
                        id : record.id,
                    ...
                    success : function(text) {
                        window.parent.unmask();
                        var data = mini.decode(text);
                        grid.updateRow(record, {qxxjfzjbl: data.zjjfbl});
                    }
                });
            }
        }
