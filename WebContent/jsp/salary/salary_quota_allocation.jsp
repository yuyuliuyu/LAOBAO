        ...
        <div showCollapseButton="true">
             <div class="mini-toolbar" style="padding:0px;border-top:0;">
                <table style="width:100%;">
                    <tr>
                        <td style="width:100%;">
                            <a class="mini-button" iconCls="icon-add" onclick="addNews()">审核</a>
                            <a class="mini-button" iconCls="icon-add" onclick="addNews()">反审核</a>
                            <a class="mini-button" iconCls="icon-add" onclick="addNews()">工资上报</a>
                        </td>
                    </tr>
                </table>
            </div>
            <div class="mini-fit">
                <div id="grid" class="mini-datagrid" style="width:100%;height:100%;" pageSize="20"
                    ...
                    <div property="columns">
                        ...
                        <div field="doctorapply" width="80" headerAlign="center" align="center">日期</div>
                        <div field="doctorapply" width="80" headerAlign="center" align="center">分配额度</div>
                        <div field="doctorapply" width="80" headerAlign="center" align="center">状态</div>
                    </div>
                </div>
            </div>
        </div>
